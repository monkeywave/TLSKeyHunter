...
frida -p $(frida-ps | grep -i docker | awk '{print $1}') -l gotls_key_dump_linux_x86_64
...
function hookGoTLSByPattern(module) {
    ...
    var pattern_mb_derive_secret =   "49 3B 66 10 0F 86 EF 00 00 00 55 48 89 E5 48 83 EC 50 4C 89 8C 24 90 00 00 00 4C 89 94 24 98 00 00 00 48 89 44 24 60 48 89 7C 24 78 48 89 5C 24 68 48 89 4C 24 70 4C 89 84 24 88 00 00 00 48 89 B4 24 80 00 00 00 4D 85 C9 75 12 48 8B 48 18 48";
    ...
    var pattern_p_hash =   "49 3B 66 10 0F 86 E1 01 00 00 55 48 89 E5 48 83 EC 58 48 89 BC 24 88 00 00 00 4C 89 9C 24 B0 00 00 00 4C 89 94 24 A8 00 00 00 4C 89 8C 24 A0 00 00 00 48 89 8C 24 80 00 00 00 48 89 5C 24 78 48 89 44 24 70 48 8B 44 24 68 48 89 FB 48 89 F1 4C";
    //var pattern_p_hash = "49 3B 66 10 0F 86 23 01  00 00 55 48 89 E5 48 83 EC 68 4C 89 8C 24 C0 00  00 00 48 89 B4 24 B0 00 00 00 48 89 BC 24 A8 00  00 00 48 89 8C 24 A0 00"
