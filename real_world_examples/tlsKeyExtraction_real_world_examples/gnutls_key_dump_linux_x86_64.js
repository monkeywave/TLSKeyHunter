...
frida -p $(frida-ps | grep -i curl | awk '{print $1}') -l universal_key_dump_liunx_x86_64.js
...
function hookGnuTLSByPattern(module) {
    ...
    var pattern_prf = "F3 0F 1E FA 55 48 89 E5 41 57 41 56 41 55 49 89 CD 8D 4F FA 41 54 53 89 FB 48 81 EC 48 05 00 00 4C 8B 75 10 64 4C 8B 24 25 28 00 00 00 4C 89 65 C8 4C 8B 65 20 83 F9 0B 77 16" 
