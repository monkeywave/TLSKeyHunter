...
frida -p $(frida-ps | grep -i chrome | awk '{print $1}') -l universal_key_dump_liunx_x86_64.js
...
function hookBoringSSLByPattern(module) {
    ...
    var pattern_mb_derive_secret = "55 48 89 E5 41 57 41 56 41 55 41 54 53 48 81 EC 98 00 00 00 4C 89 45 88 49 89 CC 49 89 D7 48 89 F3 49 89 FE 64 48 8B 04 25 28 00 00 00 48 89 45 D0 0F 28 05 98 F1 B8 FD 4C 8D 6D 90 41 0F 29 45 30 41 0F 29 45 20 41 0F 29 45 10 41 0F 29 45 00 48 B8 AA AA AA AA AA AA AA AA 48 8D 55 80 48 89";
    ...
    var pattern_prf = "55 48 89 E5 41 57 41 56 41 55 41 54 53 48 83 EC 38 BB 01 00 00 00 48 85 D2 75 11 89 D8 48 83 C4 38 5B 41 5C 41 5D 41 5E 41 5F 5D C3 4D 89 C6 49 89 D4 49 89 F5 49 89 FF 48 89 4D D0 4C 89 4D C8 48 8B 45 30 48 89 45 C0 48 8B 45 28 48 89 45 B8";
