/*
compilation: 
g++ -Iinclude -Ibuild/include -o test_client_12_boringssl_key_export test_client_12_boringssl_key_export.c build/ssl/libssl.a build/crypto/libcrypto.a -lpthread -ldl
