...
public class TestClient13BouncyCastle {
    private static String HOST = "10.0.2.2";
    private static int PORT = 4433;
    static Socket socket_bouncy_13;

    public static String run_bouncy_13(String str, int i) {
        HOST = str;
        PORT = i;
        ...
        try {
            ...
            socket_bouncy_13 = socket;
            new TlsClientProtocol(socket.getInputStream(), socket_bouncy_13.getOutputStream()).connect(new DefaultTlsClient(bcTlsCrypto) { // from class: com.example.tls_library_ground_truth.BouncyCastle.TestClient13BouncyCastle.1
                ...
                public TlsAuthentication getAuthentication() throws IOException {
                    return new TlsAuthentication() { // from class: com.example.tls_library_ground_truth.BouncyCastle.TestClient13BouncyCastle.1.1
    ...
    public static String close_bouncy_13() {
        try {
            Socket socket = socket_bouncy_13;
            if (socket != null) {
                socket.close();
