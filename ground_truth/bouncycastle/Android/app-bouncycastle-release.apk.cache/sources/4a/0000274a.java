...
public class SecP224R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1064q = SecP224R1FieldElement.f1068Q;
    ...
    public SecP224R1Curve() {
        ...
        this.f1000a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE")));
        this.f1001b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat224.copy(((SecP224R1FieldElement) eCPoint.getRawXCoord()).f1069x, 0, iArr, i3);
            Nat224.copy(((SecP224R1FieldElement) eCPoint.getRawYCoord()).f1069x, 0, iArr, i3 + 7);
            i3 += 14;
        }
