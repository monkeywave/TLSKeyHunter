...
public class Carousel extends MotionHelper {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0179R.styleable.Carousel);
    ...
    public /* synthetic */ void m294xc943cdea() {
