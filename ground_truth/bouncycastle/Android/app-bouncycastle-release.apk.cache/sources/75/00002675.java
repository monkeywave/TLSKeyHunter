...
final class ImportX509KeyManager_5 extends BCX509ExtendedKeyManager implements ImportX509KeyManager {
    ...
    public String chooseEngineClientAlias(String[] strArr, Principal[] principalArr, SSLEngine sSLEngine) {
        return this.x509KeyManager.chooseEngineClientAlias(strArr, principalArr, sSLEngine);
    }

    @Override // javax.net.ssl.X509ExtendedKeyManager
    public String chooseEngineServerAlias(String str, Principal[] principalArr, SSLEngine sSLEngine) {
        return this.x509KeyManager.chooseEngineServerAlias(str, principalArr, sSLEngine);
    }
    ...
    protected BCX509Key validateKeyBC(boolean z, String str, String str2, SSLEngine sSLEngine) {
        return ProvX509Key.validate(this.x509KeyManager, z, str, str2, TransportData.from(sSLEngine));
    }
}