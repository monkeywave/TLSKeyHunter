...
public class SubjectPublicKeyInfoFactory {
    ...
    public static SubjectPublicKeyInfo createSubjectPublicKeyInfo(AsymmetricKeyParameter asymmetricKeyParameter) throws IOException {
        if (asymmetricKeyParameter instanceof QTESLAPublicKeyParameters) {
            ...
            } else if (asymmetricKeyParameter instanceof SLHDSAPublicKeyParameters) {
            ...
            } else if (asymmetricKeyParameter instanceof MLKEMPublicKeyParameters) {
            ...
            } else if (asymmetricKeyParameter instanceof MLDSAPublicKeyParameters) {
