...
public class Zuc128CoreEngine implements StreamCipher, Memoable {
    ...
    /* renamed from: L1 */
    private static int m46L1(int i) {
        return ROT(i, 24) ^ (((ROT(i, 2) ^ i) ^ ROT(i, 10)) ^ ROT(i, 18));
    }

    /* renamed from: L2 */
    private static int m45L2(int i) {
    ...
    private void setKeyAndIV(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            LFSRWithInitialisationMode(m47F() >>> 1);
            i--;
        }
    }
    ...
    int m47F() {
        int[] iArr = this.BRC;
        int i = iArr[0];
        int[] iArr2 = this.f709F;
        int i2 = iArr2[0];
        int i3 = iArr2[1];
        int i4 = (i ^ i2) + i3;
        int i5 = i2 + iArr[1];
        int i6 = iArr[2] ^ i3;
        int m46L1 = m46L1((i5 << 16) | (i6 >>> 16));
        int m45L2 = m45L2((i6 << 16) | (i5 >>> 16));
        int[] iArr3 = this.f709F;
        byte[] bArr = f707S0;
        byte b = bArr[m46L1 >>> 24];
        byte[] bArr2 = f708S1;
        iArr3[0] = MAKEU32(b, bArr2[(m46L1 >>> 16) & 255], bArr[(m46L1 >>> 8) & 255], bArr2[m46L1 & 255]);
        this.f709F[1] = MAKEU32(bArr[m45L2 >>> 24], bArr2[(m45L2 >>> 16) & 255], bArr[(m45L2 >>> 8) & 255], bArr2[m45L2 & 255]);
        return i4;
    }
    ...
    public void reset(Memoable memoable) {
        ...
        int[] iArr3 = zuc128CoreEngine.f709F;
        int[] iArr4 = this.f709F;
