...
public class IDEACBCPar extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f266iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f266iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }

    public IDEACBCPar(byte[] bArr) {
        this.f266iv = new DEROctetString(Arrays.clone(bArr));
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f266iv;
