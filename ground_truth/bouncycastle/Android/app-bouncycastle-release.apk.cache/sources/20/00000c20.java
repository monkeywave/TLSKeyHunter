...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo327clone = transition.mo327clone();
        mo327clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo327clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo327clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo327clone);
    }
    ...
    /* renamed from: go */
    public static void m253go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m252go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo327clone = transition.mo327clone();
        sceneChangeSetup(viewGroup, mo327clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo327clone);
    }
