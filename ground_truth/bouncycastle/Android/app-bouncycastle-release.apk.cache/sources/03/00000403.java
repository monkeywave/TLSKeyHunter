...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState newState) {
        ...
        int i = C01635.f52xabc7e4ac[transitionState.ordinal()];
        if (i == 1 || i == 2) {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C01635 {
    ...
    */
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attrs, C0179R.styleable.MotionLayout);
    ...
    public void updateStateAnimate(int stateId, ConstraintSet set, int duration) {
        if (this.mScene != null && this.mCurrentState == stateId) {
            updateState(C0179R.C0182id.view_transition, getConstraintSet(stateId));
            setState(C0179R.C0182id.view_transition, -1, -1);
            updateState(stateId, set);
            MotionScene.Transition transition = new MotionScene.Transition(-1, this.mScene, C0179R.C0182id.view_transition, stateId);
