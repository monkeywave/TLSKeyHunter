...
public class ViewTransition {
    ...
    private void parseViewTransitionTags(Context context, XmlPullParser parser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0179R.styleable.ViewTransition);
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        layout.updateState(C0179R.C0182id.view_transition, current);
        layout.setState(C0179R.C0182id.view_transition, -1, -1);
        MotionScene.Transition transition = new MotionScene.Transition(-1, layout.mScene, C0179R.C0182id.view_transition, fromId);
        ...
        layout.transitionToEnd(new Runnable() { // from class: androidx.constraintlayout.motion.widget.ViewTransition$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ViewTransition.this.m293x14d7500(views);
            }
        });
    }
    ...
    public /* synthetic */ void m293x14d7500(View[] viewArr) {
        if (this.mSetsTag != -1) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it.hasNext()) {
                keyFrames2.addKey(it.next().mo311clone().setViewId(id));
            }
