...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintBaseline_toTopOf, BASELINE_TO_TOP);
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintBaseline_toBottomOf, BASELINE_TO_BOTTOM);
        ...
        mapToConstant.append(C0179R.styleable.Constraint_guidelineUseRtl, GUIDELINE_USE_RTL);
        ...
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintLeft_creator, UNUSED);
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintTop_creator, UNUSED);
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintRight_creator, UNUSED);
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintBottom_creator, UNUSED);
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintBaseline_creator, UNUSED);
        ...
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintWidth, LAYOUT_CONSTRAINT_WIDTH);
        mapToConstant.append(C0179R.styleable.Constraint_layout_constraintHeight, LAYOUT_CONSTRAINT_HEIGHT);
        ...
        mapToConstant.append(C0179R.styleable.Constraint_motionStagger, MOTION_STAGGER);
        ...
        mapToConstant.append(C0179R.styleable.Constraint_layout_wrapBehaviorInParent, LAYOUT_WRAP_BEHAVIOR);
        ...
        mapToConstant.append(C0179R.styleable.Constraint_transformPivotTarget, TRANSFORM_PIVOT_TARGET);
        mapToConstant.append(C0179R.styleable.Constraint_quantizeMotionSteps, QUANTIZE_MOTION_STEPS);
        mapToConstant.append(C0179R.styleable.Constraint_quantizeMotionPhase, QUANTIZE_MOTION_PHASE);
        mapToConstant.append(C0179R.styleable.Constraint_quantizeMotionInterpolator, QUANTIZE_MOTION_INTERPOLATOR);
        ...
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_layout_constraintLeft_creator, UNUSED);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_layout_constraintTop_creator, UNUSED);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_layout_constraintRight_creator, UNUSED);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_layout_constraintBottom_creator, UNUSED);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_layout_constraintBaseline_creator, UNUSED);
        ...
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_layout_constraintWidth, LAYOUT_CONSTRAINT_WIDTH);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_layout_constraintHeight, LAYOUT_CONSTRAINT_HEIGHT);
        ...
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_motionStagger, MOTION_STAGGER);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_motionTarget, MOTION_TARGET);
        ...
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_transformPivotTarget, TRANSFORM_PIVOT_TARGET);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_quantizeMotionSteps, QUANTIZE_MOTION_STEPS);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_quantizeMotionPhase, QUANTIZE_MOTION_PHASE);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_quantizeMotionInterpolator, QUANTIZE_MOTION_INTERPOLATOR);
        overrideMapToConstant.append(C0179R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, LAYOUT_WRAP_BEHAVIOR);
    }
    ...
    */
    ...
    public static class Layout {
        ...
        static {
            ...
            mapToConstant.append(C0179R.styleable.Layout_guidelineUseRtl, GUIDE_USE_RTL);
            ...
            mapToConstant.append(C0179R.styleable.Layout_layout_constraintLeft_creator, UNUSED);
            mapToConstant.append(C0179R.styleable.Layout_layout_constraintTop_creator, UNUSED);
            mapToConstant.append(C0179R.styleable.Layout_layout_constraintRight_creator, UNUSED);
            mapToConstant.append(C0179R.styleable.Layout_layout_constraintBottom_creator, UNUSED);
            mapToConstant.append(C0179R.styleable.Layout_layout_constraintBaseline_creator, UNUSED);
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0179R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0179R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0179R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class Motion {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0179R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m312clone());
            }
        }
    }
    ...
    */
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs, boolean override) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, override ? C0179R.styleable.ConstraintOverride : C0179R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser parser) {
        ...
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(asAttributeSet, C0179R.styleable.ConstraintOverride);
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0179R.C0182id.class.getField(trim).getInt(null);
