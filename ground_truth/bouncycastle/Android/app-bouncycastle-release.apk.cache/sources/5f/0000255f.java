...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    /* JADX WARN: Removed duplicated region for block: B:250:0x04e6 A[Catch: Exception -> 0x050d, IllegalArgumentException -> 0x0518, TryCatch #3 {IllegalArgumentException -> 0x0518, Exception -> 0x050d, blocks: (B:244:0x04bb, B:245:0x04d3, B:246:0x04d4, B:248:0x04e0, B:250:0x04e6, B:252:0x04ea, B:247:0x04db), top: B:264:0x04b2 }] */
    ...
    */
    ...
    protected void engineSetMode(String str) throws NoSuchAlgorithmException {
        ...
        if (upperCase.equals("ECB")) {
            ...
            aEADGenericBlockCipher = new BufferedGenericBlockCipher(CFBBlockCipher.newInstance(blockCipher2, blockCipher2.getBlockSize() * 8));
            ...
            this.ivLength = this.baseEngine.getBlockSize();
            this.fixedIv = false;
            aEADGenericBlockCipher = this.baseEngine instanceof DSTU7624Engine ? new BufferedGenericBlockCipher(new DefaultBufferedBlockCipher(new KCTRBlockCipher(this.baseEngine))) : new BufferedGenericBlockCipher(new DefaultBufferedBlockCipher(SICBlockCipher.newInstance(this.baseEngine)));
