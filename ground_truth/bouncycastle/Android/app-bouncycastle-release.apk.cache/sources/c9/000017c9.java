...
@DebugMetadata(m162c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", m161f = "Limit.kt", m160i = {0}, m159l = {CipherSuite.TLS_DH_RSA_WITH_SEED_CBC_SHA}, m158m = "invokeSuspend", m157n = {"collector$iv"}, m156s = {"L$0"})
...
public final class FlowKt__LimitKt$transformWhile$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C0965xdf1aa1b6 c0965xdf1aa1b6;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C0965xdf1aa1b6 c0965xdf1aa1b62 = new C0965xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
                this.L$0 = c0965xdf1aa1b62;
                this.label = 1;
                if (flow.collect(c0965xdf1aa1b62, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } catch (FlowExceptions e) {
                e = e;
                c0965xdf1aa1b6 = c0965xdf1aa1b62;
                FlowExceptions_commonKt.checkOwnership(e, c0965xdf1aa1b6);
                return Unit.INSTANCE;
            }
        } else if (i != 1) {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        } else {
            c0965xdf1aa1b6 = (C0965xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
