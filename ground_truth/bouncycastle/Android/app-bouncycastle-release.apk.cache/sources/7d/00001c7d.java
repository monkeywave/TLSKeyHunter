...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f337b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f338g;
    ...
    /* renamed from: p */
    private final BigInteger f339p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f340q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1 */
    private BigInteger f341x1;

    /* renamed from: x2 */
    private BigInteger f342x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f339p = jPAKEPrimeOrderGroup.getP();
        this.f340q = jPAKEPrimeOrderGroup.getQ();
        this.f338g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    private BigInteger calculateS() {
        try {
            return JPAKEUtil.calculateS(this.f340q, this.password);
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i < 50) {
            if (i >= 40) {
                ...
                this.password = null;
                BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f339p, this.f340q, this.gx4, this.f342x2, calculateS, this.f337b);
                this.f341x1 = null;
                this.f342x2 = null;
                this.f337b = null;
                this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        if (this.state < 10) {
            this.f341x1 = JPAKEUtil.generateX1(this.f340q, this.random);
            this.f342x2 = JPAKEUtil.generateX2(this.f340q, this.random);
            this.gx1 = JPAKEUtil.calculateGx(this.f339p, this.f338g, this.f341x1);
            this.gx2 = JPAKEUtil.calculateGx(this.f339p, this.f338g, this.f342x2);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f339p, this.f340q, this.f338g, this.gx1, this.f341x1, this.participantId, this.digest, this.random);
            BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f339p, this.f340q, this.f338g, this.gx2, this.f342x2, this.participantId, this.digest, this.random);
            this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i < 30) {
            if (i >= 20) {
                BigInteger calculateGA = JPAKEUtil.calculateGA(this.f339p, this.gx1, this.gx3, this.gx4);
                BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f340q, this.f342x2, calculateS());
                BigInteger calculateA = JPAKEUtil.calculateA(this.f339p, this.f340q, calculateGA, calculateX2s);
                BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f339p, this.f340q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
                this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f339p, this.f340q, this.f338g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f339p, this.f340q, this.f338g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        BigInteger calculateGA = JPAKEUtil.calculateGA(this.f339p, this.gx3, this.gx1, this.gx2);
        this.f337b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f339p, this.f340q, calculateGA, this.f337b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
