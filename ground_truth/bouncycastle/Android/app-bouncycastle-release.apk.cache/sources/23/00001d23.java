...
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private int[] f605kw = new int[8];

    /* renamed from: ke */
    private int[] f604ke = new int[12];
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(iArr, this.subkey, 28);
        camelliaF2(iArr, this.subkey, 32);
        camelliaFLs(iArr, this.f604ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keySize == 16) {
            ...
            if (z) {
                ...
                roldq(15, iArr2, 0, this.f604ke, 0);
                ...
                roldq(17, iArr2, 0, this.f605kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f604ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f604ke, 4);
            ...
            roldq(17, iArr2, 0, this.f605kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldqo32(51, iArr3, 0, this.f605kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f605kw, 0);
    }
