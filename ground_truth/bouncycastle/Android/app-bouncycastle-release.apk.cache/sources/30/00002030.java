...
import org.bouncycastle.asn1.p008ua.DSTU4145BinaryField;
import org.bouncycastle.asn1.p008ua.DSTU4145ECBinary;
import org.bouncycastle.asn1.p008ua.DSTU4145NamedCurves;
import org.bouncycastle.asn1.p008ua.DSTU4145Params;
import org.bouncycastle.asn1.p008ua.DSTU4145PointEncoder;
import org.bouncycastle.asn1.p008ua.UAObjectIdentifiers;
...
public class BCDSTU4145PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
        ...
        try {
            ...
            if (aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) {
                ...
                if (dSTU4145Params.isNamedCurve()) {
                    ...
                    org.bouncycastle.jce.spec.ECParameterSpec eCParameterSpec2 = new org.bouncycastle.jce.spec.ECParameterSpec(f2m, DSTU4145PointEncoder.decodePoint(f2m, g), eCBinary.getN());
                    x9ECParameters = null;
    ...
    public org.bouncycastle.math.p016ec.ECPoint getQ() {
        org.bouncycastle.math.p016ec.ECPoint q = this.ecPublicKey.getQ();
