...
@DebugMetadata(m162c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", m161f = "Zip.kt", m160i = {}, m159l = {308}, m158m = "invokeSuspend", m157n = {}, m156s = {})
...
public final class FlowKt__ZipKt$combineTransform$7<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C10141<T> extends Lambda implements Functions<T[]> {
        final /* synthetic */ Flow<T>[] $flowArray;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C10141(Flow<T>[] flowArr) {
            super(0);
            this.$flowArray = flowArr;
        }
    ...
    @DebugMetadata(m162c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", m161f = "Zip.kt", m160i = {}, m159l = {308}, m158m = "invokeSuspend", m157n = {}, m156s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* loaded from: classes.dex */
    public static final class C10152<T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> $transform;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C10152(Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C10152> continuation) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C10152 c10152 = new C10152(this.$transform, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Intrinsics.needClassReification();
            this.label = 1;
            if (Combine.combineInternal((FlowCollector) this.L$0, flowArr, new C10141(this.$flowArray), new C10152(this.$transform, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i != 1) {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        Combine.combineInternal((FlowCollector) this.L$0, flowArr, new C10141(this.$flowArray), new C10152(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}