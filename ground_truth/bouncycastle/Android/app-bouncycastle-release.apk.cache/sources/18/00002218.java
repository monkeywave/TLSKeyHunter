...
class X509CRLObject extends X509CRLImpl {
    ...
    private X509CRLInternal getInternalCRL() {
        ...
        synchronized (this.cacheLock) {
            ...
            try {
                ...
                bArr = this.f937c.getEncoded(ASN1Encoding.DER);
            } catch (IOException e) {
                bArr = null;
                x509CRLException = new X509CRLException(e);
            }
            X509CRLInternal x509CRLInternal3 = new X509CRLInternal(this.bcHelper, this.f937c, this.sigAlgName, this.sigAlgParams, this.isIndirect, bArr, x509CRLException);
            synchronized (this.cacheLock) {
    ...
    private static boolean isIndirectCRL(CertificateList certificateList) throws CRLException {
        try {
            byte[] extensionOctets = getExtensionOctets(certificateList, Extension.issuingDistributionPoint);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            } else if ((this.internalCRLValue == null || x509CRLObject.internalCRLValue == null) && (signature = this.f937c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CRLObject.f937c.getSignature())) {
                return false;
            }
