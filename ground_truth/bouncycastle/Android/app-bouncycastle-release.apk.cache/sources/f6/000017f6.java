...
@Metadata(m174d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m173d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m172k = 3, m171mv = {1, 6, 0}, m169xi = 48)
@DebugMetadata(m162c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1", m161f = "Share.kt", m160i = {}, m159l = {214, 218, 219, 225}, m158m = "invokeSuspend", m157n = {}, m156s = {})
...
public final class FlowKt__ShareKt$launchSharing$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Share.kt */
    @Metadata(m174d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m173d2 = {"<anonymous>", "", "T", "it", ""}, m172k = 3, m171mv = {1, 6, 0}, m169xi = 48)
    @DebugMetadata(m162c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$1", m161f = "Share.kt", m160i = {}, m159l = {}, m158m = "invokeSuspend", m157n = {}, m156s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$1 */
    /* loaded from: classes.dex */
    public static final class C09731 extends SuspendLambda implements Function2<Integer, Continuation<? super Boolean>, Object> {
        /* synthetic */ int I$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C09731 c09731 = new C09731(continuation);
            c09731.I$0 = ((Number) obj).intValue();
            return c09731;
        }

        public final Object invoke(int i, Continuation<? super Boolean> continuation) {
            return ((C09731) create(Integer.valueOf(i), continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Share.kt */
    @Metadata(m174d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m173d2 = {"<anonymous>", "", "T", "it", "Lkotlinx/coroutines/flow/SharingCommand;"}, m172k = 3, m171mv = {1, 6, 0}, m169xi = 48)
    @DebugMetadata(m162c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2", m161f = "Share.kt", m160i = {}, m159l = {227}, m158m = "invokeSuspend", m157n = {}, m156s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2 */
    /* loaded from: classes.dex */
    public static final class C09742 extends SuspendLambda implements Function2<SharingCommand, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $initialValue;
        final /* synthetic */ MutableSharedFlow<T> $shared;
        final /* synthetic */ Flow<T> $upstream;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C09742(Flow<? extends T> flow, MutableSharedFlow<T> mutableSharedFlow, T t, Continuation<? super C09742> continuation) {
            super(2, continuation);
            this.$upstream = flow;
            this.$shared = mutableSharedFlow;
            this.$initialValue = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C09742 c09742 = new C09742(this.$upstream, this.$shared, this.$initialValue, continuation);
            c09742.L$0 = obj;
            return c09742;
        }
        ...
        public final Object invoke2(SharingCommand sharingCommand, Continuation<? super Unit> continuation) {
            return ((C09742) create(sharingCommand, continuation)).invokeSuspend(Unit.INSTANCE);
        }
