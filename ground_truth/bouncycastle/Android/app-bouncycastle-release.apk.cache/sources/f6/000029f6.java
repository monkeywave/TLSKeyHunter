...
public class MLDSAEngine {
    ...
    public byte[] generateSignature(SHAKEDigest sHAKEDigest, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6) {
        ...
        Packing.unpackSecretKey(polyVecK2, polyVecL, polyVecK3, bArr3, bArr4, bArr5, this);
        ...
        while (i2 < 1000) {
            int i3 = i2 + 1;
            short s2 = (short) (s + 1);
            polyVecL2.uniformGamma1(bArr9, s);
            PolyVecL polyVecL5 = polyVecL4;
            polyVecL2.copyPolyVecL(polyVecL5);
            polyVecL5.polyVecNtt();
            PolyVecK polyVecK11 = polyVecK9;
            polyVecMatrix.pointwiseMontgomery(polyVecK11, polyVecL5);
            polyVecK11.reduce();
            polyVecK11.invNttToMont();
            polyVecK11.conditionalAddQ();
            PolyVecK polyVecK12 = polyVecK8;
            polyVecK11.decompose(polyVecK12);
            System.arraycopy(polyVecK11.packW1(), i, bArr8, i, this.DilithiumK * this.DilithiumPolyW1PackedBytes);
            sHAKEDigest.update(bArr7, i, 64);
            ...
            Poly poly3 = poly2;
            poly3.challenge(Arrays.copyOfRange(bArr8, i, this.DilithiumCTilde));
            poly3.polyNtt();
            polyVecL5.pointwisePolyMontgomery(poly3, polyVecL);
            polyVecL5.invNttToMont();
            polyVecL5.addPolyVecL(polyVecL2);
            polyVecL5.reduce();
            if (polyVecL5.checkNorm(this.DilithiumGamma1 - this.DilithiumBeta)) {
                polyVecK = polyVecK7;
            } else {
                polyVecK = polyVecK7;
                polyVecK.pointwisePolyMontgomery(poly3, polyVecK3);
                polyVecK.invNttToMont();
                polyVecK12.subtract(polyVecK);
                polyVecK12.reduce();
                if (polyVecK12.checkNorm(this.DilithiumGamma2 - this.DilithiumBeta)) {
                    continue;
                } else {
                    PolyVecK polyVecK13 = polyVecK10;
                    polyVecK.pointwisePolyMontgomery(poly3, polyVecK13);
                    polyVecK.invNttToMont();
                    polyVecK.reduce();
                    if (polyVecK.checkNorm(this.DilithiumGamma2)) {
                        polyVecK10 = polyVecK13;
                    } else {
                        polyVecK12.addPolyVecK(polyVecK);
                        polyVecK12.conditionalAddQ();
                        polyVecK10 = polyVecK13;
                        if (polyVecK.makeHint(polyVecK12, polyVecK11) <= this.DilithiumOmega) {
                            return Packing.packSignature(bArr8, polyVecL5, polyVecK, this);
                        }
                    }
                }
            }
