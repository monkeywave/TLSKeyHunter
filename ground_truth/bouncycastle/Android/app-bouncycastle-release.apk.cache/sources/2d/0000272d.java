...
public class SecP128R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f1015x;
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f1016y;
        ...
        SecP128R1FieldElement secP128R1FieldElement5 = (SecP128R1FieldElement) this.f1017zs[0];
        ...
        if (isOne) {
            iArr = secP128R1FieldElement3.f1035x;
            iArr2 = secP128R1FieldElement4.f1035x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement5.f1035x, create2);
            SecP128R1Field.multiply(create2, secP128R1FieldElement3.f1035x, create);
            SecP128R1Field.multiply(create2, secP128R1FieldElement5.f1035x, create2);
            SecP128R1Field.multiply(create2, secP128R1FieldElement4.f1035x, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP128R1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP128R1FieldElement.f1035x;
            iArr4 = secP128R1FieldElement2.f1035x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement6.f1035x, create3);
            SecP128R1Field.multiply(create3, secP128R1FieldElement.f1035x, createExt);
            SecP128R1Field.multiply(create3, secP128R1FieldElement6.f1035x, create3);
            SecP128R1Field.multiply(create3, secP128R1FieldElement2.f1035x, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP128R1Field.square(create, secP128R1FieldElement7.f1035x);
        SecP128R1Field.subtract(secP128R1FieldElement7.f1035x, create5, secP128R1FieldElement7.f1035x);
        SecP128R1FieldElement secP128R1FieldElement8 = new SecP128R1FieldElement(create5);
        SecP128R1Field.subtract(create2, secP128R1FieldElement7.f1035x, secP128R1FieldElement8.f1035x);
        SecP128R1Field.multiplyAddToExt(secP128R1FieldElement8.f1035x, create, createExt);
        SecP128R1Field.reduce(createExt, secP128R1FieldElement8.f1035x);
        SecP128R1FieldElement secP128R1FieldElement9 = new SecP128R1FieldElement(create4);
        if (!isOne) {
            SecP128R1Field.multiply(secP128R1FieldElement9.f1035x, secP128R1FieldElement5.f1035x, secP128R1FieldElement9.f1035x);
        }
        if (!isOne2) {
            SecP128R1Field.multiply(secP128R1FieldElement9.f1035x, secP128R1FieldElement6.f1035x, secP128R1FieldElement9.f1035x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP128R1Point(this.curve, this.f1015x, this.f1016y.negate(), this.f1017zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f1016y;
        if (secP128R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f1015x;
        SecP128R1FieldElement secP128R1FieldElement3 = (SecP128R1FieldElement) this.f1017zs[0];
        int[] create = Nat128.create();
        int[] create2 = Nat128.create();
        int[] create3 = Nat128.create();
        SecP128R1Field.square(secP128R1FieldElement.f1035x, create3);
        int[] create4 = Nat128.create();
        SecP128R1Field.square(create3, create4);
        boolean isOne = secP128R1FieldElement3.isOne();
        int[] iArr = secP128R1FieldElement3.f1035x;
        if (!isOne) {
            SecP128R1Field.square(secP128R1FieldElement3.f1035x, create2);
            iArr = create2;
        }
        SecP128R1Field.subtract(secP128R1FieldElement2.f1035x, iArr, create);
        SecP128R1Field.add(secP128R1FieldElement2.f1035x, iArr, create2);
        ...
        SecP128R1Field.square(create2, secP128R1FieldElement4.f1035x);
        SecP128R1Field.subtract(secP128R1FieldElement4.f1035x, create3, secP128R1FieldElement4.f1035x);
        SecP128R1Field.subtract(secP128R1FieldElement4.f1035x, create3, secP128R1FieldElement4.f1035x);
        SecP128R1FieldElement secP128R1FieldElement5 = new SecP128R1FieldElement(create3);
        SecP128R1Field.subtract(create3, secP128R1FieldElement4.f1035x, secP128R1FieldElement5.f1035x);
        SecP128R1Field.multiply(secP128R1FieldElement5.f1035x, create2, secP128R1FieldElement5.f1035x);
        SecP128R1Field.subtract(secP128R1FieldElement5.f1035x, create, secP128R1FieldElement5.f1035x);
        SecP128R1FieldElement secP128R1FieldElement6 = new SecP128R1FieldElement(create2);
        SecP128R1Field.twice(secP128R1FieldElement.f1035x, secP128R1FieldElement6.f1035x);
        if (!isOne) {
            SecP128R1Field.multiply(secP128R1FieldElement6.f1035x, secP128R1FieldElement3.f1035x, secP128R1FieldElement6.f1035x);
        }
