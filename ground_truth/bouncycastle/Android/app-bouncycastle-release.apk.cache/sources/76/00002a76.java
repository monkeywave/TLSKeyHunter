...
public class SABEREngine {
    ...
    /* renamed from: h1 */
    private final int f1393h1;

    /* renamed from: h2 */
    private final int f1394h2;
    ...
    public SABEREngine(int i, int i2, boolean z, boolean z2) {
        ...
        this.f1393h1 = 1 << (i4 - 11);
        this.f1394h2 = (256 - (1 << (9 - i8))) + (1 << (i4 - 11));
    ...
    private void indcpa_kem_dec(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        for (int i = 0; i < 256; i++) {
            sArr3[i] = (short) ((((sArr3[i] + this.f1394h2) - (sArr4[i] << (10 - this.SABER_ET))) & 65535) >> 9);
        }
    ...
    private void indcpa_kem_enc(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i2 = 0; i2 < this.SABER_L; i2++) {
            for (int i3 = 0; i3 < 256; i3++) {
                ...
                sArr7[i3] = (short) (((sArr7[i3] + this.f1393h1) & 65535) >>> (this.SABER_EQ - 10));
            }
        }
        ...
        for (int i4 = 0; i4 < 256; i4++) {
            sArr6[i4] = (short) ((((sArr6[i4] - (sArr5[i4] << 9)) + this.f1393h1) & 65535) >>> (10 - this.SABER_ET));
        }
    ...
    private void indcpa_kem_keypair(byte[] bArr, byte[] bArr2, SecureRandom secureRandom) {
        ...
        for (int i2 = 0; i2 < this.SABER_L; i2++) {
            for (int i3 = 0; i3 < 256; i3++) {
                ...
                sArr4[i3] = (short) (((sArr4[i3] + this.f1393h1) & 65535) >>> (this.SABER_EQ - 10));
            }
        }
