...
@Metadata(m174d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m173d2 = {"<anonymous>", "", "T", "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m172k = 3, m171mv = {1, 6, 0}, m169xi = 48)
...
public final class ChannelFlowMerge$collectTo$2<T> implements FlowCollector {
    ...
    */
    ...
    @DebugMetadata(m162c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m161f = "Merge.kt", m160i = {}, m159l = {69}, m158m = "invokeSuspend", m157n = {}, m156s = {})
    ...
    public static final class C10181 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C10181(Flow<? extends T> flow, SendingCollector<T> sendingCollector, Semaphore semaphore, Continuation<? super C10181> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C10181(this.$inner, this.$collector, this.$semaphore, continuation);
        }
