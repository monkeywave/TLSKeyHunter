...
public class DHParameters implements CipherParameters {
    ...
    /* renamed from: g */
    private BigInteger f832g;

    /* renamed from: j */
    private BigInteger f833j;
    ...
    /* renamed from: p */
    private BigInteger f836p;

    /* renamed from: q */
    private BigInteger f837q;
    ...
    public DHParameters(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, int i, int i2, BigInteger bigInteger4, DHValidationParameters dHValidationParameters) {
        ...
        this.f832g = bigInteger2;
        this.f836p = bigInteger;
        this.f837q = bigInteger3;
        this.f835m = i;
        this.f834l = i2;
        this.f833j = bigInteger4;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DHParameters) {
            ...
            return dHParameters.getP().equals(this.f836p) && dHParameters.getG().equals(this.f832g);
        }
        return false;
    }
