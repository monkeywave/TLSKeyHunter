...
public class Comparisons {
    ...
    public static /* synthetic */ int m1528$r8$lambda$OB0mUMQVuAcU0wu9PhfvNNbqqs(Comparator comparator, Comparator comparator2, Object obj, Object obj2) {
    ...
    public static final <T> Comparator<T> thenDescending(final Comparator<T> comparator, final Comparator<? super T> comparator2) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$$ExternalSyntheticLambda1
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return Comparisons.m1528$r8$lambda$OB0mUMQVuAcU0wu9PhfvNNbqqs(comparator, comparator2, obj, obj2);
            }
        };
    }
