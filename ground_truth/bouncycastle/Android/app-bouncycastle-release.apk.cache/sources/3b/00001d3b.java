...
public class GOST3412_2015Engine implements BlockCipher {
    ...
    /* renamed from: C */
    private void m77C(byte[] bArr, int i) {
        Arrays.clear(bArr);
        bArr[15] = (byte) i;
        m75L(bArr);
    }
    ...
    /* renamed from: F */
    private void m76F(byte[] bArr, byte[] bArr2, byte[] bArr3) {
    ...
    /* renamed from: S */
    private void m73S(byte[] bArr) {
        for (int i = 0; i < bArr.length; i++) {
            bArr[i] = f628PI[unsignedByte(bArr[i])];
        }
    }

    /* renamed from: X */
    private void m72X(byte[] bArr, byte[] bArr2) {
        for (int i = 0; i < bArr.length; i++) {
    ...
    private void generateSubKeys(byte[] bArr) {
        ...
        for (int i5 = 1; i5 < 5; i5++) {
            for (int i6 = 1; i6 <= 8; i6++) {
                m77C(bArr7, ((i5 - 1) * 8) + i6);
                m76F(bArr7, bArr2, bArr3);
            }
            int i7 = i5 * 2;
