...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1043q = SecP160R2FieldElement.f1046Q;
    ...
    public SecP160R2Curve() {
        ...
        this.f1000a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f1001b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawXCoord()).f1047x, 0, iArr, i3);
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawYCoord()).f1047x, 0, iArr, i3 + 5);
            i3 += 10;
        }
