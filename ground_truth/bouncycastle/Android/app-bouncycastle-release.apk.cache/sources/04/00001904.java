...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo1889dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo1889dispatch(coroutineContext, runnable);
        }
    }
