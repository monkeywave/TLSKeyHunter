...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f1532v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f1532v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
            int[] iArr = this.f1532v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f1532v = IntUtils.clone(gF2Vector.f1532v);
    }
    ...
    public Vector add(Vector vector) {
        if (vector instanceof GF2Vector) {
            ...
            if (this.length == gF2Vector.length) {
                int[] clone = IntUtils.clone(gF2Vector.f1532v);
                for (int length = clone.length - 1; length >= 0; length--) {
                    clone[length] = clone[length] ^ this.f1532v[length];
                }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof GF2Vector) {
            ...
            return this.length == gF2Vector.length && IntUtils.equals(this.f1532v, gF2Vector.f1532v);
        }
        return false;
    }
    ...
    public GF2Vector extractLeftVector(int i) {
        if (i <= this.length) {
            ...
            int i2 = i >> 5;
            int i3 = i & 31;
            System.arraycopy(this.f1532v, 0, gF2Vector.f1532v, 0, i2);
            if (i3 != 0) {
                gF2Vector.f1532v[i2] = ((1 << i3) - 1) & this.f1532v[i2];
            }
            return gF2Vector;
        }
        ...
        if (i <= this.length) {
            ...
            if (i4 != 0) {
                while (true) {
                    ...
                    int[] iArr = gF2Vector.f1532v;
                    int[] iArr2 = this.f1532v;
                    int i7 = i3 + 1;
                    iArr[i6] = (iArr2[i3] >>> i4) | (iArr2[i7] << (32 - i4));
                    i6++;
                    i3 = i7;
                }
                int[] iArr3 = gF2Vector.f1532v;
                int[] iArr4 = this.f1532v;
                int i8 = i3 + 1;
                int i9 = iArr4[i3] >>> i4;
                iArr3[i2] = i9;
                if (i8 < iArr4.length) {
                ...
                System.arraycopy(this.f1532v, i3, gF2Vector.f1532v, 0, i5);
            }
            return gF2Vector;
        }
        throw new ArithmeticException("invalid length");
    ...
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f1532v, (this.length + 7) >> 3);
    }
    ...
    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public int hashCode() {
        return (this.length * 31) + Arrays.hashCode(this.f1532v);
    }

    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public boolean isZero() {
        for (int length = this.f1532v.length - 1; length >= 0; length--) {
            if (this.f1532v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.length; i++) {
            ...
            stringBuffer.append((this.f1532v[i >> 5] & (1 << (i & 31))) == 0 ? '0' : '1');
        }
