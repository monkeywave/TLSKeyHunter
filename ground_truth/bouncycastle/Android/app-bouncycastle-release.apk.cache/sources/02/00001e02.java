...
public class GCMBlockCipher implements GCMModeCipher {
    ...
    private void initCipher() {
        ...
        if (this.atLengthPre > 0) {
            System.arraycopy(this.S_atPre, 0, this.f786S, 0, 16);
        }
    }
    ...
    private void processPartial(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (this.forEncryption) {
            ...
            gHASHPartial(this.f786S, bArr, i, i2);
        } else {
            gHASHPartial(this.f786S, bArr, i, i2);
            GCMUtil.xor(bArr, i, bArr3, 0, i2);
        }
    ...
    private void reset(boolean z) {
        ...
        this.atLength = 0L;
        this.atLengthPre = 0L;
        this.counter = Arrays.clone(this.f785J0);
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException {
        ...
        if (j2 > this.atLengthPre) {
            ...
            if (this.exp == null) {
                ...
                basicGCMExponentiator.init(this.f784H);
            }
            this.exp.exponentiateX(j3, bArr2);
            GCMUtil.multiply(this.S_at, bArr2);
            GCMUtil.xor(this.f786S, this.S_at);
        }
        byte[] bArr3 = new byte[16];
        ...
        this.cipher.processBlock(this.f785J0, 0, bArr4, 0);
        GCMUtil.xor(bArr4, this.f786S);
        int i5 = this.macSize;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (keyParameter != null) {
            ...
            this.multiplier.init(this.f784H);
            this.exp = null;
        } else if (this.f784H == null) {
    ...
    public int processBytes(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws DataLengthException {
        ...
        if (bArr.length - i >= i2) {
            ...
            i5 = i4 + 16;
            while (i16 <= length2) {
                decryptBlock(bArr, i16, bArr2, i3 + i5);
                i16 += 16;
                i5 += 16;
            }
