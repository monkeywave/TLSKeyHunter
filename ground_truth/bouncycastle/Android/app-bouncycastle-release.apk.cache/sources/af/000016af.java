...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo1842trySendJP2dKIU(E e) {
        ...
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            ...
            return closedForSend == null ? ChannelResult.Companion.m1861failurePtdJZtk() : ChannelResult.Companion.m1860closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m1860closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    private final void invokeOnCloseHandler(Throwable th) {
        ...
        if (obj == null || obj == AbstractChannelKt.HANDLER_INVOKED || !C0135xc40028dd.m296m(onCloseHandler$FU, this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if (!C0135xc40028dd.m296m(atomicReferenceFieldUpdater, this, null, function1)) {
            Object obj = this.onCloseHandler;
        ...
        Closed<?> closedForSend = getClosedForSend();
        if (closedForSend == null || !C0135xc40028dd.m296m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1888remove()) {
                receive.helpRemove();
            } else {
                m1880constructorimpl$default = InlineList.m1885plusFjFbRPM(m1880constructorimpl$default, receive);
            }
        }
        if (m1880constructorimpl$default != null) {
            if (!(m1880constructorimpl$default instanceof ArrayList)) {
                ((Receive) m1880constructorimpl$default).resumeReceiveClosed(closed);
            } else if (m1880constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) m1880constructorimpl$default;
    ...
    */
    ...
    /* compiled from: AbstractChannel.kt */
    @Metadata(m174d1 = {"\u00006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u0000*\u0004\b\u0001\u0010\u00012\u001e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u00030\u0002j\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u0003`\u0004B\u0015\u0012\u0006\u0010\u0005\u001a\u00028\u0001\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0012\u0010\n\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\rH\u0014J\u0016\u0010\u000e\u001a\u0004\u0018\u00010\u000b2\n\u0010\u000f\u001a\u00060\u0010j\u0002`\u0011H\u0016R\u0012\u0010\u0005\u001a\u00028\u00018\u0006X\u0087\u0004¢\u0006\u0004\n\u0002\u0010\t¨\u0006\u0012"}, m173d2 = {"Lkotlinx/coroutines/channels/AbstractSendChannel$TryOfferDesc;", "E", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$RemoveFirstDesc;", "Lkotlinx/coroutines/channels/ReceiveOrClosed;", "Lkotlinx/coroutines/internal/RemoveFirstDesc;", "element", "queue", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "(Ljava/lang/Object;Lkotlinx/coroutines/internal/LockFreeLinkedListHead;)V", "Ljava/lang/Object;", "failure", "", "affected", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "onPrepare", "prepareOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "Lkotlinx/coroutines/internal/PrepareOp;", "kotlinx-coroutines-core"}, m172k = 1, m171mv = {1, 6, 0}, m169xi = 48)
    /* loaded from: classes.dex */
