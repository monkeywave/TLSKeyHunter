...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ void $r8$lambda$gp6JLGBkWOxUeE1_JLllkAXyyxM(CancellableContinuation cancellableContinuation, long j) {
        m1838postFrameCallback$lambda6(cancellableContinuation, j);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1889dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void m1838postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
