...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0192R.C0194drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0192R.C0195id.notification_main_column);
            remoteViews.addView(C0192R.C0195id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0192R.C0195id.notification_main_column, 0);
            remoteViews.setViewPadding(C0192R.C0195id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0192R.C0195id.title, 8);
            remoteViews.setViewVisibility(C0192R.C0195id.text2, 8);
            remoteViews.setViewVisibility(C0192R.C0195id.text, 8);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            applyStandardTemplate.removeAllViews(C0192R.C0195id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0192R.C0195id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            applyStandardTemplate.setViewVisibility(C0192R.C0195id.actions, i);
            applyStandardTemplate.setViewVisibility(C0192R.C0195id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0192R.layout.notification_action_tombstone;
            } else {
                i = C0192R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0192R.C0195id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0192R.C0193color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0192R.C0195id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0192R.C0195id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0192R.C0195id.action_container, action.title);
            return remoteViews;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m313clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m314clone() {
            WearableExtender wearableExtender = new WearableExtender();
