...
public class GOST28147Engine implements BlockCipher {
    ...
    /* renamed from: S */
    private byte[] f627S = Sbox_Default;
    ...
    public GOST28147Engine() {
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(getAlgorithmName(), CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA256));
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(getAlgorithmName(), CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA256, cipherParameters, Utils.getPurpose(z)));
    }
