...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0602R.C0607style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0602R.attr.appBarLayoutStyle);
    }
    ...
    */
    public AppBarLayout(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        ...
        L2d:
            ...
            int[] r2 = com.google.android.material.C0602R.styleable.AppBarLayout
            int[] r5 = new int[r6]
            r0 = r7
            r1 = r10
            r3 = r11
            ...
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_android_background
            android.graphics.drawable.Drawable r11 = r10.getDrawable(r11)
            androidx.core.view.ViewCompat.setBackground(r8, r11)
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_liftOnScrollColor
        ...
        L66:
            int r11 = com.google.android.material.C0602R.attr.motionDurationMedium2
            android.content.res.Resources r0 = r8.getResources()
            int r1 = com.google.android.material.C0602R.integer.app_bar_elevation_anim_duration
            int r0 = r0.getInteger(r1)
            int r11 = com.google.android.material.motion.MotionUtils.resolveThemeDuration(r7, r11, r0)
            long r0 = (long) r11
            r8.liftOnScrollColorDuration = r0
            int r11 = com.google.android.material.C0602R.attr.motionEasingStandardInterpolator
            ...
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_expanded
        ...
        L94:
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_elevation
            boolean r11 = r10.hasValue(r11)
            if (r11 == 0) goto La6
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_elevation
        ...
        La6:
            ...
            r0 = 26
            if (r11 < r0) goto Lce
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r11 = r10.hasValue(r11)
            if (r11 == 0) goto Lbd
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r11 = r10.getBoolean(r11, r6)
        ...
        Lbd:
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r11 = r10.hasValue(r11)
            if (r11 == 0) goto Lce
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r11 = r10.getBoolean(r11, r6)
        ...
        Lce:
            ...
            int r0 = com.google.android.material.C0602R.dimen.design_appbar_elevation
            float r11 = r11.getDimension(r0)
            r8.appBarElevation = r11
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_liftOnScroll
            boolean r11 = r10.getBoolean(r11, r6)
            r8.liftOnScroll = r11
            int r11 = com.google.android.material.C0602R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r9 = r10.getResourceId(r11, r9)
            r8.liftOnScrollTargetViewId = r9
            int r9 = com.google.android.material.C0602R.styleable.AppBarLayout_statusBarForeground
    ...
    private void initializeLiftOnScrollWithColor(final MaterialShapeDrawable materialShapeDrawable) {
        ...
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.this.m249x91f594d8(materialShapeDrawable, valueAnimator);
            }
        };
    }
    ...
    public /* synthetic */ void m249x91f594d8(MaterialShapeDrawable materialShapeDrawable, ValueAnimator valueAnimator) {
    ...
    private void initializeLiftOnScrollWithElevation(Context context, final MaterialShapeDrawable materialShapeDrawable) {
        ...
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.this.m248x84b6053(materialShapeDrawable, valueAnimator);
            }
        };
    }
    ...
    public /* synthetic */ void m248x84b6053(MaterialShapeDrawable materialShapeDrawable, ValueAnimator valueAnimator) {
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C0602R.attr.state_liftable : -C0602R.attr.state_liftable;
        iArr[1] = (this.liftable && this.lifted) ? C0602R.attr.state_lifted : -C0602R.attr.state_lifted;
        iArr[2] = this.liftable ? C0602R.attr.state_collapsible : -C0602R.attr.state_collapsible;
        iArr[3] = (this.liftable && this.lifted) ? C0602R.attr.state_collapsed : -C0602R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.scrollFlags = 1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0602R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C0602R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            setScrollEffect(obtainStyledAttributes.getInt(C0602R.styleable.AppBarLayout_Layout_layout_scrollEffect, 0));
            if (obtainStyledAttributes.hasValue(C0602R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C0602R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0602R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C0602R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
