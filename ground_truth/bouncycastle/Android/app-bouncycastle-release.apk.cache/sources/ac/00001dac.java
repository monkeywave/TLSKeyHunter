...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    public KDFCounterBytesGenerator(Mac mac) {
        ...
        this.f720h = macSize;
        this.f721k = new byte[macSize];
    }

    private void generateNext() {
        int i = (this.generatedBytes / this.f720h) + 1;
        byte[] bArr = this.ios;
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f721k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f720h, i8);
            System.arraycopy(this.f721k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f720h));
