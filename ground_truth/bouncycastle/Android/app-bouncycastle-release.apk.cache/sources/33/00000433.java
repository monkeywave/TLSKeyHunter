...
public class ConstraintAttribute {
    ...
    public boolean isContinuous() {
        int i = C01771.f57x66adad53[this.mType.ordinal()];
    ...
    public void setValue(float[] value) {
        switch (C01771.f57x66adad53[this.mType.ordinal()]) {
            case 1:
            case 6:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ...
            try {
                switch (C01771.f57x66adad53[constraintAttribute.mType.ordinal()]) {
                    case 1:
    ...
    public static void parse(Context context, XmlPullParser parser, HashMap<String, ConstraintAttribute> custom) {
        ...
        Object valueOf;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0179R.styleable.CustomAttribute);
