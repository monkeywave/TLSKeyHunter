...
public final /* synthetic */ class Delay {
    ...
    public static final <T> Flow<T> m1869debounceHG0u8IE(Flow<? extends T> flow, long j) {
    ...
    public static final <T> Flow<T> m1870sampleHG0u8IE(Flow<? extends T> flow, long j) {
