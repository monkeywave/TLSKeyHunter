...
import org.bouncycastle.math.p016ec.endo.GLVTypeBEndomorphism;
import org.bouncycastle.math.p016ec.endo.GLVTypeBParameters;
import org.bouncycastle.math.p016ec.endo.ScalarSplitParameters;
...
public class SECNamedCurves {
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.1
        ...
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C1333Fp(SECNamedCurves.fromHex("DB7C2ABF62E35E668076BEAD208B"), SECNamedCurves.fromHex("DB7C2ABF62E35E668076BEAD2088"), SECNamedCurves.fromHex("659EF8BA043916EEDE8911702B22"), SECNamedCurves.fromHex("DB7C2ABF62E35E7628DFAC6561C5"), BigInteger.valueOf(1L), true));
        }
    ...
    static X9ECParametersHolder secp112r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.2
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C1333Fp(SECNamedCurves.fromHex("DB7C2ABF62E35E668076BEAD208B"), SECNamedCurves.fromHex("6127C24C05F38A0AAAF65C0EF02C"), SECNamedCurves.fromHex("51DEF1815DB5ED74FCC34C85D709"), SECNamedCurves.fromHex("36DF0AAFD8B8D7597CA10520D04B"), BigInteger.valueOf(4L), true));
        }
    ...
    static X9ECParametersHolder secp160r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.6
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C1333Fp(SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF"), SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC"), SECNamedCurves.fromHex("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45"), SECNamedCurves.fromHex("0100000000000000000001F4C8F927AED3CA752257"), BigInteger.valueOf(1L), true));
        }
    ...
    static X9ECParametersHolder secp160r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.7
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C1333Fp(SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73"), SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70"), SECNamedCurves.fromHex("B4E134D3FB59EB8BAB57274904664D5AF50388BA"), SECNamedCurves.fromHex("0100000000000000000000351EE786A818F3A1A16B"), BigInteger.valueOf(1L), true));
        }
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.10
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurveGLV(new ECCurve.C1333Fp(SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D"), ECConstants.ZERO, BigInteger.valueOf(5L), SECNamedCurves.fromHex("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7"), BigInteger.valueOf(1L), true), new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240)));
        }
    ...
    static X9ECParametersHolder secp256r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.13
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C1333Fp(SECNamedCurves.fromHex("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF"), SECNamedCurves.fromHex("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC"), SECNamedCurves.fromHex("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B"), SECNamedCurves.fromHex("FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551"), BigInteger.valueOf(1L), true));
        }
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.20
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, BigInteger.valueOf(1L), BigInteger.valueOf(1L), SECNamedCurves.fromHex("04000000000000000000020108A2E0CC0D99F8A5EF"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.21
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, SECNamedCurves.fromHex("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2"), SECNamedCurves.fromHex("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9"), SECNamedCurves.fromHex("03FFFFFFFFFFFFFFFFFFFF48AAB689C29CA710279B"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.22
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, BigInteger.valueOf(1L), SECNamedCurves.fromHex("020A601907B8C953CA1481EB10512F78744A3205FD"), SECNamedCurves.fromHex("040000000000000000000292FE77E70C12A4234C33"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.23
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m((int) CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256, 15, SECNamedCurves.fromHex("0017858FEB7A98975169E171F77B4087DE098AC8A911DF7B01"), SECNamedCurves.fromHex("00FDFB49BFE6C3A89FACADAA7A1E5BBC7CC1C2E5D831478814"), SECNamedCurves.fromHex("01000000000000000000000000C7F34A778F443ACC920EBA49"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect193r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.24
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m((int) CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256, 15, SECNamedCurves.fromHex("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B"), SECNamedCurves.fromHex("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE"), SECNamedCurves.fromHex("010000000000000000000000015AAB561B005413CCD4EE99D5"), BigInteger.valueOf(2L)));
        }
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.27
        @Override // org.bouncycastle.asn1.p009x9.X9ECParametersHolder
        protected ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.F2m(239, (int) CipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, ECConstants.ZERO, BigInteger.valueOf(1L), SECNamedCurves.fromHex("2000000000000000000000000000005A79FEC67CB6E91F1C1DA800E478A5"), BigInteger.valueOf(4L)));
        }
