...
public final class Lint {
    ...
    private static final <T> Flow<T> m1874catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m1866catch(sharedFlow, function3);
    }
