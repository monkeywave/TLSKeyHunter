...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/asn1/McEliecePrivateKey.class */
public class McEliecePrivateKey extends ASN1Object {
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f801n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f802k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f801n));
        aSN1EncodableVector.add(new ASN1Integer(this.f802k));
