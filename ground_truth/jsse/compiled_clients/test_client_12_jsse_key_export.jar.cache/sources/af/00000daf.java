...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/crypto/rainbow/util/GF2Field.class */
public class GF2Field {
    ...
    public static short multElem(short s, short s2) {
        ...
        return exps[(logs[s] + logs[s2]) % MASK];
    }
