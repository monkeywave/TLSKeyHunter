...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/ec/custom/sec/SecT571Field.class */
public class SecT571Field {
    ...
    public static void invert(long[] jArr, long[] jArr2) {
        ...
        multiply(create64, create642, create64);
        squareN(create64, Opcode.GETFIELD, create642);
        multiply(create64, create642, create64);
        squareN(create642, Opcode.GETFIELD, create642);
        multiply(create64, create642, create64);
    ...
    public static long[] precompMultiplicand(long[] jArr) {
        long[] jArr2 = new long[Opcode.D2F << 1];
        ...
        Nat.shiftUpBits64(Opcode.D2F, jArr2, 0, 4, 0L, jArr2, Opcode.D2F);
        return jArr2;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            create64[i2] = (unshuffle & 4294967295L) | (unshuffle2 << 32);
            create642[i2] = (unshuffle >>> 32) | (unshuffle2 & (-4294967296L));
        }
        long unshuffle3 = Interleave.unshuffle(jArr[i]);
        create64[4] = unshuffle3 & 4294967295L;
