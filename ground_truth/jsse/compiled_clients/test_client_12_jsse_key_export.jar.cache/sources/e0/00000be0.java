...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jce/provider/JCEElGamalPrivateKey.class */
public class JCEElGamalPrivateKey implements ElGamalPrivateKey, DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    JCEElGamalPrivateKey(ElGamalPrivateKey elGamalPrivateKey) {
        this.f632x = elGamalPrivateKey.getX();
        this.elSpec = elGamalPrivateKey.getParameters();
    }

    JCEElGamalPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f632x = dHPrivateKey.getX();
    ...
    JCEElGamalPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f632x = ASN1Integer.getInstance(privateKeyInfo.parsePrivateKey()).getValue();
    ...
    JCEElGamalPrivateKey(ElGamalPrivateKeyParameters elGamalPrivateKeyParameters) {
        this.f632x = elGamalPrivateKeyParameters.getX();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f632x = (BigInteger) objectInputStream.readObject();
