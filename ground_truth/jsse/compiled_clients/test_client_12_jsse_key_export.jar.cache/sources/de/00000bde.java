...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jce/provider/JCEECPrivateKey.class */
public class JCEECPrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    public JCEECPrivateKey(String str, ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f630d = eCPrivateKeySpec.getD();
    ...
    public JCEECPrivateKey(String str, java.security.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f630d = eCPrivateKeySpec.getS();
    ...
    public JCEECPrivateKey(String str, JCEECPrivateKey jCEECPrivateKey) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f630d = jCEECPrivateKey.f630d;
    ...
    public JCEECPrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, JCEECPublicKey jCEECPublicKey, ECParameterSpec eCParameterSpec) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f630d = eCPrivateKeyParameters.getD();
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (parsePrivateKey instanceof ASN1Integer) {
            this.f630d = ASN1Integer.getInstance(parsePrivateKey).getValue();
            return;
        }
        ECPrivateKeyStructure eCPrivateKeyStructure = new ECPrivateKeyStructure((ASN1Sequence) parsePrivateKey);
        this.f630d = eCPrivateKeyStructure.getKey();
    ...
    public String toString() {
        ...
        stringBuffer.append("             S: ").append(this.f630d.toString(16)).append(lineSeparator);
