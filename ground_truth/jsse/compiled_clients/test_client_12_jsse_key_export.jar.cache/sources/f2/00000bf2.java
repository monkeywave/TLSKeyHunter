...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8.class */
public class PKIXCertPathValidatorSpi_8 extends CertPathValidatorSpi {
    ...
    public CertPathValidatorResult engineValidate(CertPath certPath, CertPathParameters certPathParameters) throws CertPathValidatorException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            ProvRevocationChecker provRevocationChecker = null;
            ...
            for (PKIXCertPathChecker pKIXCertPathChecker : build.getCertPathCheckers()) {
                ...
                } else if (provRevocationChecker != null) {
            ...
            if (build.isRevocationEnabled() && provRevocationChecker == null) {
                    ...
                    if (build.getTargetConstraints() == null || build.getTargetConstraints().match((Certificate) ((X509Certificate) certificates.get(0)))) {
                        ...
                        while (size2 >= 0) {
                            ...
                            try {
                                ...
                                RFC3280CertPathUtilities.processCertA(certPath, build, validityDate, provRevocationChecker, size2, cAPublicKey, z, ca, trustedCert);
                        ...
                        RFC3280CertPathUtilities.wrapupCertF(certPath, size2 + 1, arrayList, hashSet);
