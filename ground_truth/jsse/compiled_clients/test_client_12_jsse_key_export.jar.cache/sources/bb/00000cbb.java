...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/ec/custom/sec/SecT193Field.class */
public class SecT193Field {
    ...
    public static long[] fromBigInteger(BigInteger bigInteger) {
        return Nat.fromBigInteger64(Opcode.INSTANCEOF, bigInteger);
    }
    ...
    protected static void implMulwAcc(long[] jArr, long j, long j2, long[] jArr2, int i) {
        ...
        jArr2[i] = jArr2[i] ^ (j4 & M49);
        int i5 = i + 1;
        jArr2[i5] = jArr2[i5] ^ ((j4 >>> 49) ^ (j3 << 15));
    }
