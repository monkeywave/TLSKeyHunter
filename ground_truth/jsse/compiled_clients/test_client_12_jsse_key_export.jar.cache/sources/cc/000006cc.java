...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi.class */
                    ...
                    if (params.containsKey(valueOf)) {
                        ...
                        if (this.strength == 1024) {
                            ...
                            if (Properties.isOverrideSet("org.bouncycastle.dsa.FIPS186-2for1024bits")) {
                                ...
                                dSAParametersGenerator.init(new DSAParameterGenerationParameters(1024, Opcode.IF_ICMPNE, defaultCertainty, this.random));
                            }
