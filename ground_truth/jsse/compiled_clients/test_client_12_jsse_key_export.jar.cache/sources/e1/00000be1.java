...
public class JCEElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    JCEElGamalPublicKey(ElGamalPublicKey elGamalPublicKey) {
        this.f633y = elGamalPublicKey.getY();
        this.elSpec = elGamalPublicKey.getParameters();
    }

    JCEElGamalPublicKey(DHPublicKey dHPublicKey) {
        this.f633y = dHPublicKey.getY();
    ...
    JCEElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f633y = elGamalPublicKeyParameters.getY();
    ...
    JCEElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f633y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public byte[] getEncoded() {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), new ASN1Integer(this.f633y));
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f633y = (BigInteger) objectInputStream.readObject();
