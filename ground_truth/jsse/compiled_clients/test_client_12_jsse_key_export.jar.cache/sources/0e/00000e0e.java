...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/crypto/xmss/XMSSNodeUtil.class */
class XMSSNodeUtil {
    XMSSNodeUtil() {
    }
    ...
    public static XMSSNode randomizeHash(WOTSPlus wOTSPlus, XMSSNode xMSSNode, XMSSNode xMSSNode2, XMSSAddress xMSSAddress) {
        ...
        return new XMSSNode(xMSSNode.getHeight(), wOTSPlus.getKhf().m1H(PRF, bArr));
    }
}