...
/* loaded from: test_client_12_jsse_key_export.jar:org/openjsse/sun/security/ssl/SSLAlgorithmDecomposer.class */
class SSLAlgorithmDecomposer extends AlgorithmDecomposer {
    private final boolean onlyX509;

    /* JADX INFO: Access modifiers changed from: package-private */
    public SSLAlgorithmDecomposer(boolean onlyX509) {
    ...
    private Set<String> decomposes(CipherSuite.MacAlg macAlg, SSLCipher cipher) {
        ...
        if (macAlg == CipherSuite.MacAlg.M_NULL && cipher.cipherType != CipherType.AEAD_CIPHER) {
            ...
            components.add("SHA1");
            components.add(McElieceCCA2KeyGenParameterSpec.SHA1);
            ...
            components.add(McElieceCCA2KeyGenParameterSpec.SHA384);
