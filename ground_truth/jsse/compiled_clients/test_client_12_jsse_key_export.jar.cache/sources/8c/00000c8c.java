...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/ec/custom/sec/SecP256K1Curve.class */
public class SecP256K1Curve extends ECCurve.AbstractFp {
    private static final int SECP256K1_DEFAULT_COORDS = 2;
    protected SecP256K1Point infinity;

    /* renamed from: q */
    public static final BigInteger f731q = SecP256K1FieldElement.f734Q;
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawXCoord()).f735x, 0, iArr, i3);
            int i5 = i3 + 8;
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawYCoord()).f735x, 0, iArr, i5);
            i3 = i5 + 8;
        }
