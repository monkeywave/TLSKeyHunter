...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/math/linearalgebra/PolynomialRingGF2.class */
public final class PolynomialRingGF2 {
    ...
    public static int rest(long j, int i) {
        ...
        while (true) {
            int i3 = i2;
            if (degree(i3) < degree(i)) {
                return i3;
            }
            i2 = i3 ^ (i << (degree(i3) - degree(i)));
        }
    }
