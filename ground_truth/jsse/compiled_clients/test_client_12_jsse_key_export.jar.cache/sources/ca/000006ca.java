...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/asymmetric/dsa/KeyFactorySpi.class */
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        if (keySpec instanceof OpenSSHPrivateKeySpec) {
            ...
            if (parsePrivateKeyBlob instanceof DSAPrivateKeyParameters) {
                return engineGeneratePrivate(new DSAPrivateKeySpec(((DSAPrivateKeyParameters) parsePrivateKeyBlob).getX(), ((DSAPrivateKeyParameters) parsePrivateKeyBlob).getParameters().getP(), ((DSAPrivateKeyParameters) parsePrivateKeyBlob).getParameters().getQ(), ((DSAPrivateKeyParameters) parsePrivateKeyBlob).getParameters().getG()));
            }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof DSAPublicKeySpec) {
            ...
            if (parsePublicKey instanceof DSAPublicKeyParameters) {
                return engineGeneratePublic(new DSAPublicKeySpec(((DSAPublicKeyParameters) parsePublicKey).getY(), ((DSAPublicKeyParameters) parsePublicKey).getParameters().getP(), ((DSAPublicKeyParameters) parsePublicKey).getParameters().getQ(), ((DSAPublicKeyParameters) parsePublicKey).getParameters().getG()));
            }
