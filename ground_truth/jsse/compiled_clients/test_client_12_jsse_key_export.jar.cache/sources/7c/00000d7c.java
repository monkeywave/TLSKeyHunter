...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/crypto/mceliece/McElieceKeyPairGenerator.class */
public class McElieceKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private void initialize(KeyGenerationParameters keyGenerationParameters) {
        ...
        this.f869m = this.mcElieceParams.getParameters().getM();
        this.f870n = this.mcElieceParams.getParameters().getN();
        this.f871t = this.mcElieceParams.getParameters().getT();
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        GF2mField gF2mField = new GF2mField(this.f869m, this.fieldPoly);
        PolynomialGF2mSmallM polynomialGF2mSmallM = new PolynomialGF2mSmallM(gF2mField, this.f871t, 'I', this.random);
        ...
        Permutation permutation2 = new Permutation(this.f870n, this.random);
        return new AsymmetricCipherKeyPair((AsymmetricKeyParameter) new McEliecePublicKeyParameters(this.f870n, this.f871t, (GF2Matrix) ((GF2Matrix) createRandomRegularMatrixAndItsInverse[0].rightMultiply(extendLeftCompactForm)).rightMultiply(permutation2)), (AsymmetricKeyParameter) new McEliecePrivateKeyParameters(this.f870n, numRows, gF2mField, polynomialGF2mSmallM, permutation, permutation2, createRandomRegularMatrixAndItsInverse[1]));
    }
