...
/* loaded from: test_client_12_jsse_key_export.jar:javassist/bytecode/LineNumberAttribute.class */
public class LineNumberAttribute extends AttributeInfo {
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:javassist/bytecode/LineNumberAttribute$Pc.class */
    public static class C0013Pc {
        public int index;
        public int line;
    }
    ...
    public C0013Pc toNearPc(int line) {
        int n = tableLength();
        int nearPc = 0;
        int distance = 0;
        if (n > 0) {
