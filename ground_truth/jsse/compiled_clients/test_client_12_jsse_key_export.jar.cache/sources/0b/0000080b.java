...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/asymmetric/util/BaseAgreementSpi.class */
public abstract class BaseAgreementSpi extends KeyAgreementSpi {
    ...
    public SecretKey engineGenerateSecret(String str) throws NoSuchAlgorithmException {
        ...
        if (oids.containsKey(upperCase)) {
            str2 = ((ASN1ObjectIdentifier) oids.get(upperCase)).getId();
        }
    ...
    static {
        ...
        keySizes.put(PKCSObjectIdentifiers.id_hmacWithSHA1.getId(), Integers.valueOf(Opcode.IF_ICMPNE));
