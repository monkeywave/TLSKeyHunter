...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/crypto/util/PrivateKeyInfoFactory.class */
public class PrivateKeyInfoFactory {
    ...
    private static XMSSMTPrivateKey xmssmtCreateKeyStructure(XMSSMTPrivateKeyParameters xMSSMTPrivateKeyParameters) throws IOException {
        ...
        int i = (height + 7) / 8;
        int bytesToXBigEndian = (int) XMSSUtil.bytesToXBigEndian(encoded, 0, i);
        if (XMSSUtil.isIndexValid(height, bytesToXBigEndian)) {
            int i2 = 0 + i;
