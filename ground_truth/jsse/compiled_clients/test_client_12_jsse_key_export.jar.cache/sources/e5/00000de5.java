...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/crypto/xmss/DefaultXMSSMTOid.class */
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    static {
        ...
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 20, 2), new DefaultXMSSMTOid(9, "XMSSMT_SHA2_20/2_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 20, 4), new DefaultXMSSMTOid(10, "XMSSMT_SHA2_20/4_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 40, 2), new DefaultXMSSMTOid(11, "XMSSMT_SHA2_40/2_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 40, 4), new DefaultXMSSMTOid(12, "XMSSMT_SHA2_40/4_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 40, 8), new DefaultXMSSMTOid(13, "XMSSMT_SHA2_40/8_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 60, 3), new DefaultXMSSMTOid(14, "XMSSMT_SHA2_60/3_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 60, 6), new DefaultXMSSMTOid(15, "XMSSMT_SHA2_60/6_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 60, 12), new DefaultXMSSMTOid(16, "XMSSMT_SHA2_60/12_512"));
        ...
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 20, 2), new DefaultXMSSMTOid(25, "XMSSMT_SHAKE_20/2_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 20, 4), new DefaultXMSSMTOid(26, "XMSSMT_SHAKE_20/4_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 40, 2), new DefaultXMSSMTOid(27, "XMSSMT_SHAKE_40/2_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 40, 4), new DefaultXMSSMTOid(28, "XMSSMT_SHAKE_40/4_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 40, 8), new DefaultXMSSMTOid(29, "XMSSMT_SHAKE_40/8_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 60, 3), new DefaultXMSSMTOid(30, "XMSSMT_SHAKE_60/3_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 60, 6), new DefaultXMSSMTOid(31, "XMSSMT_SHAKE_60/6_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 60, 12), new DefaultXMSSMTOid(32, "XMSSMT_SHAKE_60/12_512"));
