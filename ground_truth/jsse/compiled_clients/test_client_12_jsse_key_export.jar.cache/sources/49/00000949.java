...
import org.bouncycastle.asn1.p000bc.EncryptedObjectStoreData;
import org.bouncycastle.asn1.p000bc.EncryptedPrivateKeyData;
import org.bouncycastle.asn1.p000bc.EncryptedSecretKeyData;
import org.bouncycastle.asn1.p000bc.ObjectData;
import org.bouncycastle.asn1.p000bc.ObjectDataSequence;
import org.bouncycastle.asn1.p000bc.ObjectStore;
import org.bouncycastle.asn1.p000bc.ObjectStoreData;
import org.bouncycastle.asn1.p000bc.ObjectStoreIntegrityCheck;
import org.bouncycastle.asn1.p000bc.PbkdMacIntegrityCheck;
import org.bouncycastle.asn1.p000bc.SecretKeyData;
import org.bouncycastle.asn1.p000bc.SignatureCheck;
...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi.class */
public class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$Def.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$DefCompat.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$DefShared.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$DefSharedCompat.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$ExtKeyStoreException.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$SharedKeyStoreSpi.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$Std.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$StdCompat.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$StdShared.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/keystore/bcfks/BcFKSKeyStoreSpi$StdSharedCompat.class */
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                byte[] generateKey = generateKey(generatePkbdAlgorithmIdentifier, "PRIVATE_KEY_ENCRYPTION", cArr != null ? cArr : new char[0], 32);
            ...
            try {
                ...
                byte[] generateKey2 = generateKey(generatePkbdAlgorithmIdentifier2, "SECRET_KEY_ENCRYPTION", cArr != null ? cArr : new char[0], 32);
    ...
    private byte[] calculateMac(byte[] bArr, AlgorithmIdentifier algorithmIdentifier, KeyDerivationFunc keyDerivationFunc, char[] cArr) throws NoSuchAlgorithmException, IOException, NoSuchProviderException {
        ...
        try {
            createMac.init(new SecretKeySpec(generateKey(keyDerivationFunc, "INTEGRITY_CHECK", cArr != null ? cArr : new char[0], -1), id));
    ...
    private EncryptedObjectStoreData getEncryptedObjectStoreData(AlgorithmIdentifier algorithmIdentifier, char[] cArr) throws IOException, NoSuchAlgorithmException {
        ...
        try {
            if (this.storeEncryptionAlgorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_aes256_CCM)) {
                ...
                encryptedObjectStoreData = new EncryptedObjectStoreData(new AlgorithmIdentifier(PKCSObjectIdentifiers.id_PBES2, new PBES2Parameters(generatePkbdAlgorithmIdentifier, new EncryptionScheme(NISTObjectIdentifiers.id_aes256_wrap_pad))), createCipher("AESKWP", generateKey).doFinal(objectStoreData.getEncoded()));
            }
    ...
    private byte[] decryptData(String str, AlgorithmIdentifier algorithmIdentifier, char[] cArr, byte[] bArr) throws IOException {
        ...
        if (algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_PBES2)) {
            ...
            try {
                ...
                createCipher.init(2, new SecretKeySpec(generateKey(pBES2Parameters.getKeyDerivationFunc(), str, cArr != null ? cArr : new char[0], 32), "AES"), algorithmParameters);
