...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/CryptoServicesRegistrar.class */
public final class CryptoServicesRegistrar {
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/CryptoServicesRegistrar$Property.class */
    ...
    /* JADX WARN: Type inference failed for: r0v15, types: [org.bouncycastle.crypto.params.DSAParameters, T] */
    ...
    public static <T> T getSizedProperty(Property property, int i) {
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            for (int i2 = 0; i2 != lookupProperty.length; i2++) {
                ?? r0 = (T) ((DHParameters) lookupProperty[i2]);
            ...
            for (int i3 = 0; i3 != lookupProperty.length; i3++) {
                ?? r02 = (T) ((DSAParameters) lookupProperty[i3]);
    ...
    private static <T> void localSetThread(Property property, T[] tArr) {
        HashMap hashMap = threadProperties.get();
        if (hashMap == null) {
            hashMap = new HashMap();
            threadProperties.set(hashMap);
        }
        hashMap.put(property.name, tArr);
    }
    ...
    private static Object[] localClearThreadProperty(Property property) {
        ...
        return hashMap.remove(property.name);
    }
