...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/ec/custom/sec/SecT193R1Curve.class */
public class SecT193R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R1Curve() {
        super(Opcode.INSTANCEOF, 15, 0, 0);
        this.infinity = new SecT193R1Point(this, null, null);
        this.f661a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0017858FEB7A98975169E171F77B4087DE098AC8A911DF7B01")));
        this.f662b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00FDFB49BFE6C3A89FACADAA7A1E5BBC7CC1C2E5D831478814")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawXCoord()).f754x, 0, jArr, i3);
            int i5 = i3 + 4;
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawYCoord()).f754x, 0, jArr, i5);
            i3 = i5 + 4;
        }
