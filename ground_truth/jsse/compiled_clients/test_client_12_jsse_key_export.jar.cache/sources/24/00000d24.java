...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey.class */
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f796n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f797k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f796n));
        aSN1EncodableVector.add(new ASN1Integer(this.f797k));
