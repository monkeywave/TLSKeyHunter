...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/crypto/xmss/DefaultXMSSOid.class */
public final class DefaultXMSSOid implements XMSSOid {
    ...
    static {
        ...
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 10), new DefaultXMSSOid(4, "XMSS_SHA2_10_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 16), new DefaultXMSSOid(5, "XMSS_SHA2_16_512"));
        hashMap.put(createKey("SHA-512", 64, 16, Opcode.LXOR, 20), new DefaultXMSSOid(6, "XMSS_SHA2_20_512"));
        ...
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 10), new DefaultXMSSOid(10, "XMSS_SHAKE_10_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 16), new DefaultXMSSOid(11, "XMSS_SHAKE_16_512"));
        hashMap.put(createKey("SHAKE256", 64, 16, Opcode.LXOR, 20), new DefaultXMSSOid(12, "XMSS_SHAKE_20_512"));
