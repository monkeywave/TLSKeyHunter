...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/raw/Nat384.class */
public abstract class Nat384 {
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int addTo = addToEachOther + Nat192.addTo(iArr3, 18, iArr3, 12, addToEachOther + Nat192.addTo(iArr3, 0, iArr3, 6, 0));
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        int addTo = addToEachOther + Nat192.addTo(iArr2, 18, iArr2, 12, addToEachOther + Nat192.addTo(iArr2, 0, iArr2, 6, 0));
        int[] create = Nat192.create();
