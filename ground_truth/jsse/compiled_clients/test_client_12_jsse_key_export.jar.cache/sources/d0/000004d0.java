...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/generators/SCrypt.class */
public class SCrypt {
    private SCrypt() {
    }
    ...
    private static void SMix(int[] iArr, int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            for (int i9 = 0; i9 < i6; i9++) {
                int[] iArr6 = new int[i5 * i8];
                r0[i9] = iArr6;
                int i10 = 0;
                for (int i11 = 0; i11 < i5; i11 += 2) {
                    System.arraycopy(iArr5, 0, iArr6, i10, i8);
                    int i12 = i10 + i8;
                    BlockMix(iArr5, iArr2, iArr3, iArr4, i4);
                    System.arraycopy(iArr4, 0, iArr6, i12, i8);
                    i10 = i12 + i8;
            ...
            for (int i14 = 0; i14 < i2; i14++) {
                ...
                System.arraycopy(r0[i15 >>> numberOfTrailingZeros], (i15 & i7) * i8, iArr4, 0, i8);
