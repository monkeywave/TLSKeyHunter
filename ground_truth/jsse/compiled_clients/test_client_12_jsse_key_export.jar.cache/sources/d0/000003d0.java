...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/agreement/jpake/JPAKEPrimeOrderGroup.class */
public class JPAKEPrimeOrderGroup {

    /* renamed from: p */
    private final BigInteger f99p;

    /* renamed from: q */
    private final BigInteger f100q;

    /* renamed from: g */
    private final BigInteger f101g;
    ...
    public JPAKEPrimeOrderGroup(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, boolean z) {
        ...
        this.f99p = bigInteger;
        this.f100q = bigInteger2;
        this.f101g = bigInteger3;
    }
