...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/pqc/crypto/newhope/NewHope.class */
class NewHope {
    ...
    static void encodeB(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int i = 0; i < 256; i++) {
            int i2 = 4 * i;
            bArr[1792 + i] = (byte) (sArr2[i2] | (sArr2[i2 + 1] << 2) | (sArr2[i2 + 2] << 4) | (sArr2[i2 + 3] << 6));
        }
    }
