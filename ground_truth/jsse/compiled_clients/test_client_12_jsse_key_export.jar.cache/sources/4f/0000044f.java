...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/engines/ARIAEngine.class */
public class ARIAEngine implements BlockCipher {

    /* renamed from: C */
    private static final byte[][] f301C = {Hex.decodeStrict("517cc1b727220a94fe13abe8fa9a6ee0"), Hex.decodeStrict("6db14acc9e21c820ff28b1d5ef5de2b0"), Hex.decodeStrict("db92371d2126e9700324977504e8c90e")};
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        ...
        while (i3 < length) {
            int i4 = i3;
            int i5 = i3 + 1;
            m64FO(bArr3, this.roundKeys[i4]);
            i3 = i5 + 1;
            m65FE(bArr3, this.roundKeys[i5]);
        }
        int i6 = i3;
        int i7 = i3 + 1;
        m64FO(bArr3, this.roundKeys[i6]);
    ...
    /* renamed from: A */
    protected static void m66A(byte[] bArr) {
        byte b = bArr[0];
        byte b2 = bArr[1];
        byte b3 = bArr[2];
        byte b4 = bArr[3];
    ...
    /* renamed from: FE */
    protected static void m65FE(byte[] bArr, byte[] bArr2) {
        xor(bArr, bArr2);
        SL2(bArr);
        m66A(bArr);
    }
    ...
    /* renamed from: FO */
    protected static void m64FO(byte[] bArr, byte[] bArr2) {
        xor(bArr, bArr2);
        SL1(bArr);
        m66A(bArr);
    }
    ...
    protected static byte[][] keySchedule(boolean z, byte[] bArr) {
        ...
        int i = (length >>> 3) - 2;
        byte[] bArr2 = f301C[i];
        byte[] bArr3 = f301C[(i + 1) % 3];
        byte[] bArr4 = f301C[(i + 2) % 3];
        ...
        if (i2 > 12) {
            ...
            if (i2 > 14) {
                ...
                keyScheduleRound(bArr11[16], bArr7, bArr8, Opcode.LDIV);
            }
        }
        if (!z) {
            reverseKeys(bArr11);
