...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jce/provider/JCEDHPrivateKey.class */
public class JCEDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    JCEDHPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f628x = dHPrivateKey.getX();
        this.dhSpec = dHPrivateKey.getParams();
    }

    JCEDHPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f628x = dHPrivateKeySpec.getX();
    ...
    JCEDHPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f628x = aSN1Integer.getValue();
    ...
    JCEDHPrivateKey(DHPrivateKeyParameters dHPrivateKeyParameters) {
        this.f628x = dHPrivateKeyParameters.getX();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f628x = (BigInteger) objectInputStream.readObject();
