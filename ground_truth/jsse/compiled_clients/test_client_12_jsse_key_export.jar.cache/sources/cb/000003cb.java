...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/agreement/SM2KeyExchange.class */
public class SM2KeyExchange {
    ...
    public void init(CipherParameters cipherParameters) {
        ...
        this.f92w = (this.ecParams.getCurve().getFieldSize() / 2) - 1;
    }
    ...
    public byte[][] calculateKeyWithConfirmation(int i, byte[] bArr, CipherParameters cipherParameters) {
        ...
        if (!this.initiator) {
            ...
            return new byte[]{kdf, m123S1(this.digest, calculateU, calculateInnerHash), m122S2(this.digest, calculateU, calculateInnerHash)};
        }
        ...
        if (Arrays.constantTimeAreEqual(m123S1(this.digest, calculateU, calculateInnerHash2), bArr)) {
            return new byte[]{kdf2, m122S2(this.digest, calculateU, calculateInnerHash2)};
        }
    ...
    private BigInteger reduce(BigInteger bigInteger) {
        return bigInteger.and(BigInteger.valueOf(1L).shiftLeft(this.f92w).subtract(BigInteger.valueOf(1L))).setBit(this.f92w);
    }

    /* renamed from: S1 */
    private byte[] m123S1(Digest digest, ECPoint eCPoint, byte[] bArr) {
    ...
    /* renamed from: S2 */
    private byte[] m122S2(Digest digest, ECPoint eCPoint, byte[] bArr) {
