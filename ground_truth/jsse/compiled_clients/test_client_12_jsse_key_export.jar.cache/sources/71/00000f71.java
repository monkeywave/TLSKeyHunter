...
@Deprecated
/* loaded from: test_client_12_jsse_key_export.jar:org/openjsse/com/sun/net/ssl/internal/www/protocol/https/HttpsURLConnectionOldImpl.class */
public class HttpsURLConnectionOldImpl extends HttpsURLConnection {
    ...
    public HttpsURLConnectionOldImpl(URL u, Proxy p, Handler handler) throws IOException {
        super(checkURL(u));
    ...
    @Override // org.openjsse.com.sun.net.ssl.HttpsURLConnection
