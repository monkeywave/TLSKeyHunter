...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/engines/GOST28147Engine.class */
public class GOST28147Engine implements BlockCipher {
    ...
    /* renamed from: S */
    private byte[] f337S = Sbox_Default;
    ...
    private int GOST28147_mainStep(int i, int i2) {
        int i3 = i2 + i;
        int i4 = (this.f337S[0 + ((i3 >> 0) & 15)] << 0) + (this.f337S[16 + ((i3 >> 4) & 15)] << 4) + (this.f337S[32 + ((i3 >> 8) & 15)] << 8) + (this.f337S[48 + ((i3 >> 12) & 15)] << 12) + (this.f337S[64 + ((i3 >> 16) & 15)] << 16) + (this.f337S[80 + ((i3 >> 20) & 15)] << 20) + (this.f337S[96 + ((i3 >> 24) & 15)] << 24) + (this.f337S[Opcode.IREM + ((i3 >> 28) & 15)] << 28);
        return (i4 << 11) | (i4 >>> 21);
    }
    ...
    private void GOST28147Func(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (this.forEncryption) {
            ...
            for (int i6 = 7; i6 > 0; i6--) {
                int i7 = bytesToint;
                bytesToint = bytesToint2 ^ GOST28147_mainStep(bytesToint, iArr[i6]);
                bytesToint2 = i7;
            }
        } else {
            ...
            for (int i10 = 0; i10 < 3; i10++) {
                for (int i11 = 7; i11 >= 0 && (i10 != 2 || i11 != 0); i11--) {
                    int i12 = bytesToint;
                    bytesToint = bytesToint2 ^ GOST28147_mainStep(bytesToint, iArr[i11]);
                    bytesToint2 = i12;
                }
            }
        }
        int GOST28147_mainStep = bytesToint2 ^ GOST28147_mainStep(bytesToint, iArr[0]);
        intTobytes(bytesToint, bArr2, i2);
        intTobytes(GOST28147_mainStep, bArr2, i2 + 4);
    }
