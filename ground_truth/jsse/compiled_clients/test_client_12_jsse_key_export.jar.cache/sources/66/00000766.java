...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PrivateKey.class */
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    /* renamed from: d */
    private transient BigInteger f602d;
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f602d = eCPrivateKeySpec.getD();
    ...
    public BCECGOST3410_2012PrivateKey(java.security.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f602d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410_2012PrivateKey(BCECGOST3410_2012PrivateKey bCECGOST3410_2012PrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f602d = bCECGOST3410_2012PrivateKey.f602d;
    ...
    public BCECGOST3410_2012PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f602d = eCPrivateKeyParameters.getD();
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if ((aSN1Primitive instanceof ASN1Sequence) && (ASN1Sequence.getInstance(aSN1Primitive).size() == 2 || ASN1Sequence.getInstance(aSN1Primitive).size() == 3)) {
            ...
            if (privateKey.getOctets().length == 32 || privateKey.getOctets().length == 64) {
                this.f602d = new BigInteger(1, Arrays.reverse(privateKey.getOctets()));
                return;
            }
            ASN1Encodable parsePrivateKey = privateKeyInfo.parsePrivateKey();
            if (parsePrivateKey instanceof ASN1Integer) {
                this.f602d = ASN1Integer.getInstance(parsePrivateKey).getPositiveValue();
                return;
            } else {
                this.f602d = new BigInteger(1, Arrays.reverse(ASN1OctetString.getInstance(parsePrivateKey).getOctets()));
                return;
            }
        }
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            if (namedCurveByOid == null) {
                ...
                this.ecSpec = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(aSN1ObjectIdentifier), EC5Util.convertCurve(byOIDX9.getCurve(), byOIDX9.getSeed()), EC5Util.convertPoint(byOIDX9.getG()), byOIDX9.getN(), byOIDX9.getH());
            } else {
    ...
    public byte[] getEncoded() {
        ...
        int orderBitLength;
        boolean z = this.f602d.bitLength() > 256;
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f602d, engineGetSpec());
    }
