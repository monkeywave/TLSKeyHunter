...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/raw/Nat512.class */
public abstract class Nat512 {
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int addTo = addToEachOther + Nat256.addTo(iArr3, 24, iArr3, 16, addToEachOther + Nat256.addTo(iArr3, 0, iArr3, 8, 0));
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        int addTo = addToEachOther + Nat256.addTo(iArr2, 24, iArr2, 16, addToEachOther + Nat256.addTo(iArr2, 0, iArr2, 8, 0));
        int[] create = Nat256.create();
