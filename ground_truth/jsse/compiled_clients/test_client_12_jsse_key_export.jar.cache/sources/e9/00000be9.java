...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jce/provider/OcspCache.class */
class OcspCache {
    ...
    public static OCSPResponse getOcspResponse(CertID certID, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, URI uri, X509Certificate x509Certificate, List<Extension> list, JcaJceHelper jcaJceHelper) throws CertPathValidatorException {
        ...
        if (map != null) {
            OCSPResponse oCSPResponse = map.get(certID);
        ...
        try {
            ...
            try {
                ...
                if (0 == oCSPResponse2.getResponseStatus().getIntValue()) {
                ...
                throw new CertPathValidatorException("configuration error: " + e2.getMessage(), e2, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
            }
