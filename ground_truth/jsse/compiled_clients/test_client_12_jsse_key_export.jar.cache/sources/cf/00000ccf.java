...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/ec/custom/sec/SecT239K1Point.class */
public class SecT239K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        return new SecT239K1Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{eCFieldElement});
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT239K1Point(curve, square2, square3.add(add).add(square).multiply(square3).add(isOne ? eCFieldElement3 : square.square()).add(square2).add(multiply), new ECFieldElement[]{multiply});
    }
