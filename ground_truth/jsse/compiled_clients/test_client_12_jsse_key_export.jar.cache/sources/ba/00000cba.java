...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/ec/custom/sec/SecT163R2Point.class */
public class SecT163R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        return new SecT163R2Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{eCFieldElement});
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT163R2Point(curve, square2, (isOne ? eCFieldElement : eCFieldElement.multiply(eCFieldElement3)).squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }
