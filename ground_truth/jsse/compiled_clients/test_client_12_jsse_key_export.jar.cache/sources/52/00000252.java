...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/asn1/anssi/ANSSINamedCurves.class */
public class ANSSINamedCurves {
    static X9ECParametersHolder FRP256v1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.anssi.ANSSINamedCurves.1
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve configureCurve = ANSSINamedCurves.configureCurve(new ECCurve.C0277Fp(fromHex, fromHex2, fromHex3, fromHex4, valueOf));
