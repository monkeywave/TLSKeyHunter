...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/asn1/x509/CertificatePolicies.class */
public class CertificatePolicies extends ASN1Object {
    ...
    public PolicyInformation getPolicyInformation(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        for (int i = 0; i != this.policyInformation.length; i++) {
            if (aSN1ObjectIdentifier.equals((ASN1Primitive) this.policyInformation[i].getPolicyIdentifier())) {
