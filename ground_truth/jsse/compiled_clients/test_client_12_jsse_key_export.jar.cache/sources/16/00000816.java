...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/asymmetric/util/ECUtil.class */
public class ECUtil {
    ...
    public static ECDomainParameters getDomainParameters(ProviderConfiguration providerConfiguration, X962Parameters x962Parameters) {
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            eCDomainParameters = new ECNamedDomainParameters(aSN1ObjectIdentifier, namedCurveByOid);
    ...
    public static ASN1ObjectIdentifier getNamedCurveOid(String str) {
        ...
        return null != oid ? oid : ECNamedCurveTable.getOID(str);
    }
