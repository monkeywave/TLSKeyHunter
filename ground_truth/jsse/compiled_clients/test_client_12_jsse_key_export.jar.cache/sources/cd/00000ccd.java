...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/ec/custom/sec/SecT239K1Curve.class */
public class SecT239K1Curve extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy64(((SecT239FieldElement) eCPoint.getRawXCoord()).f756x, 0, jArr, i3);
            int i5 = i3 + 4;
            Nat256.copy64(((SecT239FieldElement) eCPoint.getRawYCoord()).f756x, 0, jArr, i5);
            i3 = i5 + 4;
        }
