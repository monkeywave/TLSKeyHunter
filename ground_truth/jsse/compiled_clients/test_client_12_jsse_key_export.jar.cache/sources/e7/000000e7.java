...
/* loaded from: test_client_12_jsse_key_export.jar:javassist/bytecode/annotation/Annotation.class */
public class Annotation {
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:javassist/bytecode/annotation/Annotation$Pair.class */
    ...
    public Annotation(String typeName, ConstPool cp) {
        this(cp.addUtf8Info(Descriptor.m130of(typeName)), cp);
    }

    public Annotation(ConstPool cp, CtClass clazz) throws NotFoundException {
        this(cp.addUtf8Info(Descriptor.m130of(clazz.getName())), cp);
