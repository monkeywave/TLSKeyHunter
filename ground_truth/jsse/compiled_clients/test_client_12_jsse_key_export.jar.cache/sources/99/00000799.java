...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey.class */
public class BCElGamalPrivateKey implements ElGamalPrivateKey, DHPrivateKey, PKCS12BagAttributeCarrier {
    static final long serialVersionUID = 4819350091141529678L;

    /* renamed from: x */
    private BigInteger f604x;
    ...
    public BCElGamalPrivateKey(ElGamalPrivateKey elGamalPrivateKey) {
        this.f604x = elGamalPrivateKey.getX();
        this.elSpec = elGamalPrivateKey.getParameters();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCElGamalPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f604x = dHPrivateKey.getX();
    ...
    public BCElGamalPrivateKey(ElGamalPrivateKeySpec elGamalPrivateKeySpec) {
        this.f604x = elGamalPrivateKeySpec.getX();
    ...
    public BCElGamalPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f604x = dHPrivateKeySpec.getX();
    ...
    public BCElGamalPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f604x = ASN1Integer.getInstance(privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public BCElGamalPrivateKey(ElGamalPrivateKeyParameters elGamalPrivateKeyParameters) {
        this.f604x = elGamalPrivateKeyParameters.getX();
