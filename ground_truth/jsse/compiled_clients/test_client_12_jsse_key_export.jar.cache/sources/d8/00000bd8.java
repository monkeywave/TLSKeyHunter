...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jce/provider/CrlCache.class */
class CrlCache {
    private static final int DEFAULT_TIMEOUT = 15000;
    private static Map<URI, WeakReference<PKIXCRLStore>> cache = Collections.synchronizedMap(new WeakHashMap());

    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jce/provider/CrlCache$LocalCRLStore.class */
