...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/math/ec/custom/sec/SecP224K1Curve.class */
public class SecP224K1Curve extends ECCurve.AbstractFp {
    private static final int SECP224K1_DEFAULT_COORDS = 2;
    protected SecP224K1Point infinity;

    /* renamed from: q */
    public static final BigInteger f720q = SecP224K1FieldElement.f723Q;
    ...
    public SecP224K1Curve() {
        ...
        this.f662b = fromBigInteger(BigInteger.valueOf(5L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawXCoord()).f724x, 0, iArr, i3);
            int i5 = i3 + 7;
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawYCoord()).f724x, 0, iArr, i5);
            i3 = i5 + 7;
        }
            ...
            public ECPoint lookup(int i6) {
                ...
                for (int i8 = 0; i8 < i2; i8++) {
                    ...
                    for (int i10 = 0; i10 < 7; i10++) {
                        ...
                        int i12 = i10;
                        create2[i12] = create2[i12] ^ (iArr[(i7 + 7) + i10] & i9);
                    }
                    i7 += 14;
                }
