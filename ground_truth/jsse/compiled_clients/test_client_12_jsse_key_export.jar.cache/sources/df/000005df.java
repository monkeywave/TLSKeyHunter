...
import org.bouncycastle.crypto.p005io.CipherOutputStream;
...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/util/CipherFactory.class */
public class CipherFactory {
    ...
    public static Object createContentCipher(boolean z, CipherParameters cipherParameters, AlgorithmIdentifier algorithmIdentifier) throws IllegalArgumentException {
        ...
        if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.rc4)) {
            ...
            AEADBlockCipher createAEADCipher2 = createAEADCipher(algorithmIdentifier.getAlgorithm());
            CCMParameters cCMParameters = CCMParameters.getInstance(algorithmIdentifier.getParameters());
            if (cipherParameters instanceof KeyParameter) {
                createAEADCipher2.init(z, new AEADParameters((KeyParameter) cipherParameters, cCMParameters.getIcvLen() * 8, cCMParameters.getNonce()));
