...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/crypto/engines/CamelliaEngine.class */
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private int[] f316kw = new int[8];

    /* renamed from: ke */
    private int[] f317ke = new int[12];
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyIs128) {
            if (z) {
                this.f316kw[0] = iArr[0];
                this.f316kw[1] = iArr[1];
                this.f316kw[2] = iArr[2];
                this.f316kw[3] = iArr[3];
                ...
                roldq(15, iArr2, 0, this.f317ke, 0);
                ...
                roldq(17, iArr2, 0, this.f316kw, 4);
                return;
            }
            this.f316kw[4] = iArr[0];
            this.f316kw[5] = iArr[1];
            this.f316kw[6] = iArr[2];
            this.f316kw[7] = iArr[3];
            decroldq(15, iArr, 0, this.subkey, 28);
            decroldq(30, iArr, 0, this.subkey, 20);
            decroldq(15, iArr, 0, iArr4, 0);
            this.subkey[16] = iArr4[0];
            this.subkey[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f317ke, 0);
        ...
        if (z) {
            ...
            roldqo32(51, iArr3, 0, this.f316kw, 4);
            return;
        }
        this.f316kw[4] = iArr[0];
        this.f316kw[5] = iArr[1];
        ...
        this.f317ke[2] = iArr2[1];
        this.f317ke[3] = iArr2[2];
        this.f317ke[0] = iArr2[3];
        this.f317ke[1] = iArr2[0];
        ...
        roldqo32(51, iArr3, 0, this.f316kw, 0);
    }
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f317ke, 8);
