...
/* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2.class */
public final class RC2 {

    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$AlgParamGen.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$AlgParams.class */
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        protected byte[] engineGetEncoded() {
            return Arrays.clone(this.f618iv);
        }
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && this.parameterVersion != -1) {
                return this.parameterVersion < 256 ? new RC2ParameterSpec(ekb[this.parameterVersion], this.f618iv) : new RC2ParameterSpec(this.parameterVersion, this.f618iv);
            } else if (cls == IvParameterSpec.class) {
                return new IvParameterSpec(this.f618iv);
            } else {
        ...
        protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f618iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
                ...
                this.f618iv = ((RC2ParameterSpec) algorithmParameterSpec).getIV();
            }
        }

        @Override // java.security.AlgorithmParametersSpi
        protected void engineInit(byte[] bArr) throws IOException {
            this.f618iv = Arrays.clone(bArr);
        }
        ...
        protected void engineInit(byte[] bArr, String str) throws IOException {
            ...
            this.f618iv = rC2CBCParameter.getIV();
        }
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$CBC.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$CBCMAC.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$CFB8MAC.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$ECB.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$KeyGenerator.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$Mappings.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithMD2KeyFactory.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithMD5AndRC2.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithMD5KeyFactory.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithSHA1AndRC2.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithSHA1KeyFactory.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithSHAAnd128BitKeyFactory.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithSHAAnd128BitRC2.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithSHAAnd40BitKeyFactory.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$PBEWithSHAAnd40BitRC2.class */
    ...
    /* loaded from: test_client_12_jsse_key_export.jar:org/bouncycastle/jcajce/provider/symmetric/RC2$Wrap.class */
