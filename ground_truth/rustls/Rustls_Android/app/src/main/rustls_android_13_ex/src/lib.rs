...
#[no_mangle]
pub extern "C" fn Java_com_example_rustls_1android_RustTls_runTlsClient13Ex(env: JNIEnv, instance: JObject) -> jni::sys::jstring {
...
fn do_rust_13() -> String {
    ...
    let ip = "10.0.2.2";
    let ip_with_port = "10.0.2.2:4433";
    ...
    debug!("TLS Connected to: {:?}", ip_with_port);
