...
public:
    ...
    void printBytesToConsole(const std::vector<uint8_t>& bytes) {
    ...
    // Log the key material to console
    void tls_ssl_key_log_data(std::string_view label,
        ...
        // Print label, random and secret
        std::cout << label << " ";
        /*
        // This code has the problem that it would print 0x6 for value 0x06
        for(const auto& byte: client_random){
            std::cout << std::hex << static_cast<int>(byte);
        }*/
        printBytesToConsole(client_random);
        std::cout << " ";
        /*
        for(const auto& byte: secret){
            std::cout << std::hex << static_cast<int>(byte);
        }*/
        printBytesToConsole(secret);
...
// Policy to enforce TLS 1.3 and allow SSL key log file
